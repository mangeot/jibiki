...
\centering
	...
	\hline
	\end{tabular}
\caption{Trois niveaux de traduction et affichage : \Japonais{国連} de japonais vers toutes les langues}\label{table}
\end{table}
...
\end{center} 
\caption{\Japonais{国連} de japonais vers toutes les langues} \label{image} \
\end{figure}
