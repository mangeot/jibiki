...
Grâce au volume d’axie, nous pouvons faire les liens entre les lexies exactement correspondus, comme l’acronyme français « ONU » lie avec l’acronyme anglais « UN ». Grâce à la couche « PRO »,  nous pouvons proposer les lexies des langues cibles de même sens.  Voir la figure \ref{image-proaxie}.
...
\end{figure}
La notion d’étiquette a pour but de proposer les meilleures traductions. Par exemple, le japonais «\Japonais{ 国際連合 }» est la lexie de sens de « Organisation des nations unies », son acronyme est « \Japonais{国連} » comme la table 1 - « Exemple de quatre langues pour le sens « Organisation des nations unies ». Cet acronyme utilise le premier et le troisième caractère de kanji, ce n’est pas utilisé les initiales de lexie de définition. Il existe sans-doute une langue qui a deux acronymes, un correspond à l’acronyme initiales, un autre correspond à la sélection de caractère ou de mot.  Donc, nous avons décidé de ne pas lier ces deux types acronymes avec un même axie. Voir la figure \ref{image-liens-lexies-axies}. \\
\begin{table}[!h]
\centering
...
\centering
	...
	\hline
	\end{tabular}
\caption{ Trois niveaux de traduction et affichage : UN d'anglais vers toutes les langues}\label{table-scenario1}
\end{table}
...
\end{center} 
\caption{UN d'anglais vers toutes les langues} \label{image-scenario1-1} \
\end{figure}
...
\end{center} 
\caption{Affichage complet - UN d'anglais vers toutes les langues} \label{image-scenario1-2} \
\end{figure}
...
\subsection{scénario 2 :  \Japonais{国連} de japonais vers toutes les langues}
...
\centering
	...
	\hline
	\end{tabular}
\caption{Trois niveaux de traduction et affichage : \Japonais{国連} de japonais vers toutes les langues}\label{table-scenario2}
\end{table}
...
\end{center} 
\caption{\Japonais{国連} de japonais vers toutes les langues} \label{image-scenario2} \
\end{figure}
...
\centering
	...
	\hline
	\end{tabular}
\caption{Trois niveaux de traduction et affichage : onusien de français vers toutes les langues}\label{table-scenario3}
\end{table}
