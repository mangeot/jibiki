 ...
 *
 * Revision 1.1  2001/07/11 12:45:45  serasset
 * *** empty log message ***
 *
 *-----------------------------------------------
 * 
...
public class NotAValidUTF8Message extends Exception {
        
    NotAValidUTF8Message() { super(); }
    NotAValidUTF8Message(String s) { super(s); }
}
