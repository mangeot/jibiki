...
public class PapillonArchiveIsLocked extends Exception {
        
    PapillonArchiveIsLocked() { super(); }
    PapillonArchiveIsLocked(String s) { super(s); }
}
