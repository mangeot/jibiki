...
// --Commented out by Inspection START (12/21/06 12:17 PM):
//	// constants
//	protected static final  String MESSAGE_ENCODING="UTF-8";
// --Commented out by Inspection STOP (12/21/06 12:17 PM)

    // Use a Transformer for output
	// protected static final TransformerFactory myTransformerFactory = TransformerFactory.newInstance();

    // Cette méthode ne semble appellée nul part.
    // De plus, un essai montre que certains caractères ont été perdu,
    // il y a donc certainement des problèmes de synchronisation
...
//   }
     ...
     *   error).
     */
    // Jamais appelé, plus implémentation pourrie:
    //  - parcours non optimal (utiliser getFirstChild...)
    //  - construction d'une chaîne de caractère à chaque appel puis recopie dans une nouvelle
    //    (utiliser un striung buffer passé en paramètres...
...
// --Commented out by Inspection START (12/21/06 12:08 PM):
...
//
//    }
// --Commented out by Inspection STOP (12/21/06 12:08 PM)
...
//                   javax.xml.parsers.ParserConfigurationException, PapillonBusinessException {
//
...
//                PapillonLogger.writeDebugMsg(encodeDef.length+" encodage a modifi√à");
//                for(int j=0;j<encodeDef.length;j++)
//                {
//                    Node curDef=encodeDef[j];
//                    PapillonLogger.writeDebugMsg("encodage pr√àc√àdent :"+curDef.getNodeValue());
//                    PapillonLogger.writeDebugMsg("encodage modifi√à");
//
...
//                PapillonLogger.writeDebugMsg(XMLServices.xmlCode(myDoc));
//                PapillonLogger.writeDebugMsg("WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW");
//
//                //creating the new bytearrayinputstream
//                ByteArrayInputStream currentBytes=new ByteArrayInputStream(XMLServices.xmlCode(myDoc).getBytes("UTF-8"));
//
//
//
...
// --Commented out by Inspection START (12/21/06 12:09 PM):
...
//
//    }
// --Commented out by Inspection STOP (12/21/06 12:09 PM)
...
// --Commented out by Inspection START (12/21/06 12:16 PM):
//		/**
...
//	}
// --Commented out by Inspection STOP (12/21/06 12:16 PM)

// --Commented out by Inspection START (12/21/06 12:10 PM):
//		/**
...
//	}
// --Commented out by Inspection STOP (12/21/06 12:10 PM)
...
// --Commented out by Inspection STOP (12/21/06 12:09 PM)
    ...
    // NOTE: IsInArray did not do anything !!!!
    //
