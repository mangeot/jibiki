...
public class Group {
    ...
    /**
        ...
        public Group() throws PapillonBusinessException {
            try {
                this.myDO = GroupDO.createVirgin();
            ...
            throws PapillonBusinessException {
                ...
                if (null != users && !users.equals("")){
                    ...
                    try {
                        ...
                        throw new PapillonBusinessException("Error building the regular expression in getAdminsArray", ex);
                    }
                    Users = myRegExp.split(users);
                }
                return Users;
