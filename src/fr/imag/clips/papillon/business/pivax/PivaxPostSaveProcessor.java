 ...
 * Projet Papillon
 *-----------------------
 * $Id: LexALPPostSaveProcessor.java,v 1.7 2007/02/08 15:52:47 fbrunet Exp $
 *------------------------
 * $Log: LexALPPostSaveProcessor.java,v $
...
public class PivaxPostSaveProcessor implements ResultPostSaveProcessor {
    ...
    public void transformation(VolumeEntry volumeEntry, User user) throws PapillonBusinessException {
        try {
            ...
            if (volumeEntry != null) {
                ...
                if (!volumeEntry.getVolumeName().equals("Pivax_axi")) {
                ...
                if (volumeEntry.getVolumeName().equals("Pivax_axi") && getReferencedLexieIds(volumeEntry).size()!=0) {
            ...
            //
            throw new PapillonBusinessException("Exception in PivaxPostProcessor.transformation()", ex);
        }	
