 ...
 * Projet Papillon
 *-----------------------------------------------
 * $Id: AdvancedSearch.java 1308 2012-06-06 14:17:07Z zhangying $
 *-----------------------------------------------
 * $Log$
...
public class AdvancedSearchTest extends PapillonBasePO {
    ...
    throws HttpPresentationException, IOException, SessionException {
        ...
        AdvancedSearchTestXHTML content = (AdvancedSearchTestXHTML) MultilingualXHtmlTemplateFactory.createTemplate("AdvancedSearchTestXHTML", this.myComms, this.sessionData);
...
//        formHolder.appendChild(content.importNode(qf.getQueryFormNode("AdvancedSearchTest.po"), true));
//        
//        
