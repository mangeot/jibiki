...
public class Project extends PapillonBasePO {

    public Node getContent()
        throws HttpPresentationException, IOException {

	ProjectTmplXHTML content;

	// Création du contenu
	//content = (InfosTmplHTML)this.getComms().xmlcFactory.create(InfosTmplHTML.class);
        content = (ProjectTmplXHTML)MultilingualXHtmlTemplateFactory.createTemplate("ProjectTmplXHTML", this.getComms(), this.getSessionData());
