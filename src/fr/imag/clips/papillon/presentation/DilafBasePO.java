 ...
 *  Projet Papillon
 *  -----------------------------------------------
 *  $Id: PapillonBasePO.java 1296 2011-11-29 17:57:22Z mangeot $
 *  -----------------------------------------------
 *  $Log$
 ...
 */
public abstract class DilafBasePO extends AbstractPO {
    ...
    *  Description of the Field
     ...
     * @exception  Exception  Description of the Exception
     */
    public abstract Node getContextualMenuContent() throws Exception;
     ...
     * @exception  Exception  Description of the Exception
     */
    public abstract Node getBannerContent() throws Exception;
    ...
    public Node getDocument()
        throws HttpPresentationException, IOException, Exception {
			...
			//Insertion de la bannière dans le document vide.
			if (banner!=null) {
				org.w3c.dom.Node origBanner = stdLayout.getBannerContent();
				stdLayout.getBannerPlaceHolder().removeChild(origBanner);
				stdLayout.getBannerPlaceHolder().appendChild(stdLayout.getLayout().importNode(banner, true));
			}
            
			//Insertion du menu contextuel dans le document vide.
			if (contextualMenu!=null) {
				((org.enhydra.xml.xhtml.dom.XHTMLElement) stdLayout.getContentPlaceHolder()).setAttribute("style","margin-right:auto;");
				stdLayout.getContextualMenuPlaceHolder().appendChild(stdLayout.getLayout().importNode(contextualMenu, true));
			}
