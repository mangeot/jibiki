 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/eng/AdvancedQueryForm.xhtml
 */
public class AdvancedQueryFormXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdvancedQueryFormXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.AdvancedQueryFormXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/eng/AdvancedQueryForm.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node7 = document.createComment("option label=\"all\" value=\"0\">all</option");
        $elem6.appendChild($node7);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Variant");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Writing");
        $attr7.appendChild($node8);
        ...
        $node7 = document.createComment("option value=\"cdm-definition\" label=\"Definition\">Definition</option");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("At (yyyy/mm/dd)");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Contrib id");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Level");
        $attr7.appendChild($node8);
        ...
        $node7 = document.createComment("option value=\"5\" label=\"ends with\">ends with</option>\n                      <option value=\"4\" label=\"contains\">contains</option");
        $elem6.appendChild($node7);
