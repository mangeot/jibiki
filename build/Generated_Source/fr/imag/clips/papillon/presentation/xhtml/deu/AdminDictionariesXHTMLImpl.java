 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/deu/AdminDictionaries.xhtml
 */
public class AdminDictionariesXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdminDictionariesXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.AdminDictionariesXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/deu/AdminDictionaries.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("Verwaltung der XML-W");
        ...
        $node9 = document.createTextNode("Bermerkung: Die Datei der W");
        $elem8.appendChild($node9);
        ...
        $node9 = document.createTextNode("rterb");
        $elem8.appendChild($node9);
        
        $node9 = document.createEntityReference("uuml");
        $elem8.appendChild($node9);
        
        $node10 = document.createTextNode("\u00fc");
        $node9.appendChild($node10);
        
        $node9 = document.createTextNode("chermetadaten mu");
        $elem8.appendChild($node9);
        ...
        $node9 = document.createTextNode(" sich an das <dictionary-metadata>-Element des DML-Schemas halten.\n Die letzte Version des Schemas wird gefunden in : ");
        $elem8.appendChild($node9);
        ...
        $node9 = document.createTextNode("Auch Volumes-Metadaten hochladen:");
        $elem8.appendChild($node9);
        ...
        $node9 = document.createTextNode("Auch Volumes-Metadaten und Eintr");
        $elem8.appendChild($node9);
        ...
        $node7 = document.createTextNode("Metadaten");
        $elem6.appendChild($node7);
        ...
        $node7 = document.createTextNode("Alles");
        $elem6.appendChild($node7);
        ...
        $element_Sources = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem7;$node8 = document.createTextNode("Src");
        $elem7.appendChild($node8);
        ...
        $element_Targets = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem7;$node8 = document.createTextNode("Trg");
        $elem7.appendChild($node8);
        ...
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("return confirm('Are you sure you want to remove the metadata?')");
        $attr7.appendChild($node8);
        
        $element_RemoveAnchor = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem7;$node8 = document.createTextNode("l");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "onclick");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("return confirm('Are you sure you want to remove the metadata and the entries?')");
        $attr7.appendChild($node8);
        
        $element_RemoveAllAnchor = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem7;$node8 = document.createTextNode("l");
        $elem7.appendChild($node8);
