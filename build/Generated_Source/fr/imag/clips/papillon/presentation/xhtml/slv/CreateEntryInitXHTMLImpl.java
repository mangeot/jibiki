 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/slv/CreateEntryInit.xhtml
 */
public class CreateEntryInitXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements CreateEntryInitXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.CreateEntryInitXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/slv/CreateEntryInit.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("-Cr\u00e9ation d'une nouvelle entr\u00e9e");
        ...
        $node6 = document.createTextNode("POZOR: \u010ce \u017eelite ustvariti vnos, mora va");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode(" brskalnik omogo\u010dati pojavna okna !");
        $elem5.appendChild($node6);
        ...
        $node7 = document.createTextNode("Ta vnos \u017ee obstaja. Bi ga radi vseeno ustvarili ?");
        $elem6.appendChild($node7);
        ...
        $node8 = document.createTextNode("Entr\u00e9e:");
        $elem7.appendChild($node8);
        ...
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("vseeno ustvari");
        $attr6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("cr\u00e9er");
        $attr7.appendChild($node8);
