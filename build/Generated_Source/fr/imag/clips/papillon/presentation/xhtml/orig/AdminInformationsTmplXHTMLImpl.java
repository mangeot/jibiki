 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/orig/AdminInformationsTmpl.xhtml
 */
public class AdminInformationsTmplXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdminInformationsTmplXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/orig/AdminInformationsTmpl.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("Administration of InformationFiles");
        ...
        $attr9 = document.createAttributeNS("", "label");
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("Select...");
        $attr9.appendChild($node10);
        ...
        $node9 = document.createTextNode("Creation");
        $elem8.appendChild($node9);
        ...
        $node9 = document.createTextNode("Date (dd/mm/yyyy):");
        $elem8.appendChild($node9);
        ...
        $node6 = document.createTextNode("*: required only for monolingual documents without the archive description file ");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("Documents currently in the database:");
        $elem5.appendChild($node6);
        ...
        $node8 = document.createTextNode("Replace");
        $elem7.appendChild($node8);
        ...
        $attr8 = document.createAttributeNS("", "value");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("Replace");
        $attr8.appendChild($node9);
        ...
        $element_RemoveAnchor = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem8;$node9 = document.createTextNode("Remove");
        $elem8.appendChild($node9);
