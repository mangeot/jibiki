 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/slv/ImportHelpContent.xhtml
 */
public class ImportHelpContentXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements ImportHelpContentXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.ImportHelpContentXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/slv/ImportHelpContent.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("Pour les deux types de documents multilingues, l'archive doit comporter \u00e0 sa racine le fichier info_doc.xml puis, pour chaque jezik, un r\u00e9pertoire portant\nle code ");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode(" trois lettres ISO 639-2/T de cette jezik. Les langues actuellement accept\u00e9es sont");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("Chaque r\u00e9pertoire portant le nom d'une langue doit au moins contenir un fichier index nomm\u00e9 index.htm(l)\nou default.htm(l), qui sera le point d'entr\u00e9e dans le document pour cette jezik. Si le fichier info_doc.xml est absent, vous pouvez remplir le champ ");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("Chaque r\u00e9pertoire portant le nom d'une jezik doit contenir exactement un fichier, la version du document\n dans cette jezik. La pr\u00e9sence du fichier info_doc.xml est obligatoire.");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode(" du \n formulaire et indiquer la jezik du document.");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("Vous devez donner le titre du document et indiquer sa jezik dans le formulaire.");
        $elem4.appendChild($node5);
