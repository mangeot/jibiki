 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/fra/AdvancedQueryFormTest.xhtml
 */
public class AdvancedQueryFormTestXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdvancedQueryFormTestXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final Class XMLC_GENERATED_CLASS = AdvancedQueryFormTestXHTMLImpl.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class can be regenerated from.
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/fra/AdvancedQueryFormTest.xhtml";
     ...
     * Default constructor.
     */
    public AdvancedQueryFormTestXHTMLImpl() {
        buildDocument();
    }
     ...
     */
    public AdvancedQueryFormTestXHTMLImpl(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     * Copy constructor.
     */
    public AdvancedQueryFormTestXHTMLImpl(AdvancedQueryFormTestXHTMLImpl src) {
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $attr10 = document.createAttributeNS("", "name");
        $elem10.setAttributeNode($attr10);
        $node11 = document.createTextNode("SOURCE");
        $attr10.appendChild($node11);
        ...
        $attr10 = document.createAttributeNS("", "id");
        $elem10.setAttributeNode($attr10);
        $node11 = document.createTextNode("NumberOfCriteria");
        $attr10.appendChild($node11);
        
        $attr10 = document.createAttributeNS("", "name");
        $elem10.setAttributeNode($attr10);
        $node11 = document.createTextNode("CRITERIA_NB");
        $attr10.appendChild($node11);
        
        $attr10 = document.createAttributeNS("", "type");
        $elem10.setAttributeNode($attr10);
        $node11 = document.createTextNode("hidden");
        $attr10.appendChild($node11);
        
        $element_NumberOfCriteria = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem10;$node10 = document.createTextNode("\n                  ");
        $elem9.appendChild($node10);
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new AdvancedQueryFormTestXHTMLImpl(this);
    }
