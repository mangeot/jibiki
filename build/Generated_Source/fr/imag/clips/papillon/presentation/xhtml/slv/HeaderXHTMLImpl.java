 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/slv/Header.xhtml
 */
public class HeaderXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements HeaderXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.HeaderXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/slv/Header.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node8 = document.createTextNode("Pr\u00e9sentation");
        ...
        $node8 = document.createTextNode("M\u00e9thodes d'acc\u00e8s");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Plus d'infos");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Liens utiles");
        $elem7.appendChild($node8);
        ...
        $node7 = document.createTextNode("Option One");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "li");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Option Two");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "li");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Option Three");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("Liste de distribution");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("Kontakt");
        $elem5.appendChild($node6);
        ...
        $node7 = document.createTextNode("Option Un");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "li");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Option Deux");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "li");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Option Trois");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("Pomo\u010d");
        $elem5.appendChild($node6);
