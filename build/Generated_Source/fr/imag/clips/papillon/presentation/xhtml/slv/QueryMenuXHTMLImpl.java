 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/slv/QueryMenu.xhtml
 */
public class QueryMenuXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements QueryMenuXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.QueryMenuXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/slv/QueryMenu.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("javascript:alert('Traduction d\u2019un mot')");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Traduction d\u2019un mot");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Consultation");
        ...
        $node10 = document.createTextNode("ot");
        ...
        $node11 = document.createTextNode("C");
        $elem10.appendChild($node11);
        
        $node10 = document.createTextNode("ible");
        $elem9.appendChild($node10);
        ...
        $element_QMAllTargetsOption = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem10;$node11 = document.createTextNode("vsi jeziki");
        $elem10.appendChild($node11);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Iskanje");
        $attr7.appendChild($node8);
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Fonction de recherche avanc\u00e9e d'un mot");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Napredno iskanje");
        $elem4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Liste des dictionnaires");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Seznam slovarjev");
        $elem4.appendChild($node5);
