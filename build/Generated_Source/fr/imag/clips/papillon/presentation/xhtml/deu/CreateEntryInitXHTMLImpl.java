 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/deu/CreateEntryInit.xhtml
 */
public class CreateEntryInitXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements CreateEntryInitXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.CreateEntryInitXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/deu/CreateEntryInit.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("-Erstellung neuer Eintr");
        ...
        $node6 = document.createTextNode("ACHTUNG: Um Eintr");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("ge zu erstellen, muss Ihr Browser Pop-up Fenster erlauben. !");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("New entry \"");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("\" create in ");
        $elem5.appendChild($node6);
        ...
        $node7 = document.createTextNode("This entry exists. Would you like to create it anyway ?");
        $elem6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "style");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("width:110px");
        $attr6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("create anyway");
        $attr6.appendChild($node7);
        ...
        $node9 = document.createTextNode("Stichwort:");
        $elem8.appendChild($node9);
        ...
        $attr7 = document.createAttributeNS("", "style");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("width:110px");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("erstellen");
        $attr7.appendChild($node8);
