 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/orig/UserLanguageSelect.xhtml
 */
public class UserLanguageSelectXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements UserLanguageSelectXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/orig/UserLanguageSelect.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node7 = document.createTextNode("arabiya");
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("ara");
        $attr6.appendChild($node7);
        
        $node7 = document.createTextNode("\u0639\u0631\u0628\u064a\u0629");
        ...
        $attr6 = document.createAttributeNS("", "label");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Catala");
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("cat");
        $attr6.appendChild($node7);
        
        $node7 = document.createTextNode("Catal\u00e0");
        $elem6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "label");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("espanol");
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("esp");
        $attr6.appendChild($node7);
        
        $node7 = document.createTextNode("espa\u00f1ol");
        $elem6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "label");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("nihongo");
        $attr6.appendChild($node7);
        ...
        $node7 = document.createTextNode("\u65e5\u672c\u8a9e");
        $elem6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "label");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Melayu");
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("msa");
        $attr6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "label");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Russian");
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("rus");
        $attr6.appendChild($node7);
        
        $node7 = document.createTextNode("\u0420\u0443\u0441\u0441\u043a\u0438\u0439");
        $elem6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "label");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("jiantizhongwen");
        $attr6.appendChild($node7);
        ...
        $node7 = document.createTextNode("\u7b80\u4f53\u4e2d\u6587");
        $elem6.appendChild($node7);
