 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/deu/AdminEntriesTmpl.xhtml
 */
public class AdminEntriesTmplXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdminEntriesTmplXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.AdminEntriesTmplXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/deu/AdminEntriesTmpl.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("Verwaltung des XML-Eintr");
        ...
        $node9 = document.createTextNode("Beim Importieren der Beitr");
        $elem8.appendChild($node9);
        ...
        $node9 = document.createTextNode("ge:");
        $elem8.appendChild($node9);
        
        $elem7 = document.createElementNS("http://www.w3.org/1999/xhtml", "td");
        $elem6.appendChild($elem7);
        
        $node8 = document.createTextNode("Remplacer l'existant");
        $elem7.appendChild($node8);
        ...
        $node10 = document.createTextNode("Nicht importieren");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("In allen F");
        $elem9.appendChild($node10);
        
        $node10 = document.createEntityReference("auml");
        $elem9.appendChild($node10);
        
        $node11 = document.createTextNode("\u00e4");
        $node10.appendChild($node11);
        
        $node10 = document.createTextNode("llen austauschen");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("Ausstauschen, wenn gleicher Status");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("Ausstauschen, wenn fertig");
        $elem9.appendChild($node10);
        ...
        $node9 = document.createTextNode("Beim Importieren der Eintr");
        $elem8.appendChild($node9);
        ...
        $node10 = document.createTextNode("llen kopieren");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("Kopieren, wenn gleicher Status");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("Kopieren, wenn fertig");
        $elem9.appendChild($node10);
        ...
        $node8 = document.createTextNode("Standardstatus");
        $elem7.appendChild($node8);
        ...
        $node10 = document.createTextNode("fertig");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("nicht fertig");
        $elem9.appendChild($node10);
        
        $node9 = document.createComment("option value=\"revised\" label=\"revised\">gegengelesen</option>\n            <option value=\"validated\" label=\"validated\">validiert</option");
        $elem8.appendChild($node9);
