 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/orig/History.xhtml
 */
public class HistoryXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements HistoryXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLDivElement $element_HistoryContent;

    private org.enhydra.xml.xhtml.dom.XHTMLParagraphElement $element_ModificationAuthor;

    private org.enhydra.xml.xhtml.dom.XHTMLParagraphElement $element_ModificationComment;

    private org.enhydra.xml.xhtml.dom.XHTMLParagraphElement $element_ModificationDate;
    ...
    /**
     * Class attribute constant for element class historyColumn
     */
    public static final String CLASS_historyColumn = "historyColumn";

    /**
     * Field that is used to identify this as the XMLC generated class
     * in an inheritance chain. Contains a reference to the class object.
     */
    public static final Class XMLC_GENERATED_CLASS = HistoryXHTMLImpl.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class can be regenerated from.
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/orig/History.xhtml";
     ...
     */
    public HistoryXHTMLImpl(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     * Copy constructor.
     */
    public HistoryXHTMLImpl(HistoryXHTMLImpl src) {
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node4 = document.createTextNode("HistoryContent");
        ...
        $element_HistoryContent = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem3;$node4 = document.createTextNode("\n");
        $elem3.appendChild($node4);
        ...
        $node6 = document.createTextNode("Sorry, this entry does not exist yet, You can contribute by ");
        ...
        $node7 = document.createTextNode("adding");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(" it to the dictionary !");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("Note: you have to be ");
        $elem5.appendChild($node6);
        ...
        $node7 = document.createTextNode("logged");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(" in order to contribute.");
        $elem5.appendChild($node6);
        
        $node4 = document.createTextNode("      \n");
        $elem3.appendChild($node4);
        
        $node4 = document.createComment("div id=\"HomeContent\"></div");
        $elem3.appendChild($node4);
        ...
        $node6 = document.createTextNode("No entries found in direct lookup, these entries were found in reverse lookup, hence, the translations might not be accurate.");
        $elem5.appendChild($node6);
        
        $node4 = document.createTextNode("      \n");
        $elem3.appendChild($node4);
        
        $node4 = document.createComment(" classic search ");
        $elem3.appendChild($node4);
        ...
        $node8 = document.createTextNode(" entries retrieved:");
        ...
        $node8 = document.createTextNode("Part-of-Speech");
        $elem7.appendChild($node8);
        ...
        $element_DictionaryName = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem8;$node9 = document.createTextNode("DictName");
        $elem8.appendChild($node9);
        ...
        $element_Formula = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem8;$node9 = document.createTextNode("Formula");
        $elem8.appendChild($node9);
        ...
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("bottom");
        $attr6.appendChild($node7);
        ...
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("historyColumn");
        $attr6.appendChild($node7);
        ...
        $node9 = document.createTextNode("Modify by :");
        $elem8.appendChild($node9);
        ...
        $attr8 = document.createAttributeNS("", "id");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("modificationAuthor");
        $attr8.appendChild($node9);
        
        $element_ModificationAuthor = (org.enhydra.xml.xhtml.dom.XHTMLParagraphElement)$elem8;$node8 = document.createTextNode("\n                ");
        $elem7.appendChild($node8);
        ...
        $attr8 = document.createAttributeNS("", "id");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("modificationDate");
        $attr8.appendChild($node9);
        
        $element_ModificationDate = (org.enhydra.xml.xhtml.dom.XHTMLParagraphElement)$elem8;$node8 = document.createTextNode("\n                ");
        $elem7.appendChild($node8);
        ...
        $attr8 = document.createAttributeNS("", "id");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("modificationComment");
        $attr8.appendChild($node9);
        
        $element_ModificationComment = (org.enhydra.xml.xhtml.dom.XHTMLParagraphElement)$elem8;$node8 = document.createTextNode("\n            ");
        $elem7.appendChild($node8);
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new HistoryXHTMLImpl(this);
    }
    ...
    /**
     * Get the element with id <CODE>HistoryContent</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLDivElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLDivElement getElementHistoryContent() {
        return $element_HistoryContent;
    }

    /**
     * Get the element with id <CODE>modificationAuthor</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLParagraphElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLParagraphElement getElementModificationAuthor() {
        return $element_ModificationAuthor;
    }

    /**
     * Get the element with id <CODE>modificationComment</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLParagraphElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLParagraphElement getElementModificationComment() {
        return $element_ModificationComment;
    }

    /**
     * Get the element with id <CODE>modificationDate</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLParagraphElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLParagraphElement getElementModificationDate() {
        return $element_ModificationDate;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagHistoryContent() {
        return $element_HistoryContent;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagModificationAuthor() {
        return $element_ModificationAuthor;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagModificationComment() {
        return $element_ModificationComment;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagModificationDate() {
        return $element_ModificationDate;
    }
    ...
    /**
     * Get the value of text child of element <CODE>HistoryContent</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextHistoryContent(String text) {
        doSetText($element_HistoryContent, text);
    }

    /**
     * Get the value of text child of element <CODE>modificationAuthor</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextModificationAuthor(String text) {
        doSetText($element_ModificationAuthor, text);
    }

    /**
     * Get the value of text child of element <CODE>modificationComment</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextModificationComment(String text) {
        doSetText($element_ModificationComment, text);
    }

    /**
     * Get the value of text child of element <CODE>modificationDate</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextModificationDate(String text) {
        doSetText($element_ModificationDate, text);
    }
