 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/orig/AdminDictionaries.xhtml
 */
public class AdminDictionariesXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdminDictionariesXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/orig/AdminDictionaries.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("Manage the XML Dictionaries");
        ...
        $node9 = document.createTextNode("NB: The Dictionary Metadata file must be valid against the <dictionary-metadata> element of the DML schema. The latest version of the schema can be found at: ");
        $elem8.appendChild($node9);
        ...
        $node9 = document.createTextNode("Load Also Volumes Metadata:");
        $elem8.appendChild($node9);
        ...
        $node9 = document.createTextNode("Load Also Volumes Metadata and Entries:");
        $elem8.appendChild($node9);
        ...
        $node4 = document.createTextNode("\n\nDictionaries currently in the database:\n");
        $elem3.appendChild($node4);
        ...
        $node7 = document.createTextNode("category");
        $elem6.appendChild($node7);
        ...
        $node7 = document.createTextNode("domain");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "th");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("legal");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "th");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Metadata");
        $elem6.appendChild($node7);
