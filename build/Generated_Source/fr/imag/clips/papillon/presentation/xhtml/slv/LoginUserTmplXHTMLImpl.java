 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/slv/LoginUserTmpl.xhtml
 */
public class LoginUserTmplXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LoginUserTmplXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.LoginUserTmplXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/slv/LoginUserTmpl.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("Stran za registracijo");
        ...
        $node10 = document.createTextNode("u");
        ...
        $node11 = document.createTextNode("U");
        $elem10.appendChild($node11);
        
        $node10 = document.createTextNode("porabni");
        ...
        $attr9 = document.createAttributeNS("", "accesskey");
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("g");
        $attr9.appendChild($node10);
        ...
        $node11 = document.createTextNode("G");
        $elem10.appendChild($node11);
        
        $node10 = document.createTextNode("eslo");
        $elem9.appendChild($node10);
        ...
        $node9 = document.createTextNode("Shrani moje geslo v pi\u0161kotek za eno leto");
        ...
        $attr8 = document.createAttributeNS("", "value");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("Prijava");
        $attr8.appendChild($node9);
        ...
        $node5 = document.createTextNode("nov uporabnik? \n");
        $elem4.appendChild($node5);
        ...
        $node6 = document.createTextNode("registriraj se!");
