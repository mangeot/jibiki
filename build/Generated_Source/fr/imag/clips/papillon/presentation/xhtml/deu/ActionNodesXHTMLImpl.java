 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/deu/ActionNodes.xhtml
 */
public class ActionNodesXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements ActionNodesXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.ActionNodesXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_EntryGroups;
    ...
    /**
     * Class attribute constant for element class jibiki_groups
     */
    public static final String CLASS_jibiki_groups = "jibiki_groups";
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/deu/ActionNodes.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node6 = document.createTextNode("jibiki_groups");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "id");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("EntryGroups");
        $attr5.appendChild($node6);
        
        $element_EntryGroups = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem5;$node5 = document.createTextNode("\n        ");
        $elem4.appendChild($node5);
        ...
        $element_EditEntryAnchor = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("editieren");
        $elem5.appendChild($node6);
        ...
        $element_DuplicateEntryAnchor = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("duplizieren & editieren");
        $elem5.appendChild($node6);
        ...
        $element_DeleteEntryAnchor = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("l");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("schen");
        $elem5.appendChild($node6);
        ...
        $element_ViewAxieAnchor = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("Axie zeigen");
        $elem5.appendChild($node6);
        ...
        $element_ViewXmlAnchor = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("XML zeigen");
        $elem5.appendChild($node6);
    ...
    /**
     * Get the element with id <CODE>EntryGroups</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLSpanElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLSpanElement getElementEntryGroups() {
        return $element_EntryGroups;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagEntryGroups() {
        return $element_EntryGroups;
    }
    ...
    /**
     * Get the value of text child of element <CODE>EntryGroups</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextEntryGroups(String text) {
        doSetText($element_EntryGroups, text);
    }
