 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/fra/EditEntryInit.xhtml
 */
public class EditEntryInitXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements EditEntryInitXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.EditEntryInitXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final Class XMLC_GENERATED_CLASS = EditEntryInitXHTMLImpl.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class can be regenerated from.
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/fra/EditEntryInit.xhtml";
     ...
     */
    public EditEntryInitXHTMLImpl(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     * Copy constructor.
     */
    public EditEntryInitXHTMLImpl(EditEntryInitXHTMLImpl src) {
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node4 = document.createTextNode("Edition of Papillon Entry");
        ...
        $node5 = document.createComment(" \n                // Open a new interface window to create the new entry \n                function create() {\n                    href = 'EditEntryInit.po?action=createAnyway&VOLUME=' + document.getElementById('VOLUME').value + '&Headword=' +  document.getElementById('Headword').value;\n                    window.open(href,'EditEntry');\n                }\n            //");
        $elem4.appendChild($node5);
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new EditEntryInitXHTMLImpl(this);
    }
