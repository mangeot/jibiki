 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/orig/ExportVolumeTmpl.xhtml
 */
public class ExportVolumeTmplXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements ExportVolumeTmplXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/orig/ExportVolumeTmpl.xhtml";
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $attr4 = document.createAttributeNS("", "label");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("modification date");
        $attr4.appendChild($node5);
        
        $attr4 = document.createAttributeNS("", "value");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("cdm-contribution-modification-date");
        $attr4.appendChild($node5);
    ...
    private void buildSubDocument_0_0(org.w3c.dom.Document document,
        ...
        $attr3 = document.createAttributeNS("", "label");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("modification date");
        $attr3.appendChild($node4);
        
        $attr3 = document.createAttributeNS("", "value");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("cdm-contribution-modification-date");
        $attr3.appendChild($node4);
