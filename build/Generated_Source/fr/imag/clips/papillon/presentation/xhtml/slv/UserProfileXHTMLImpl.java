 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/slv/UserProfile.xhtml
 */
public class UserProfileXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements UserProfileXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.UserProfileXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/slv/UserProfile.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node9 = document.createTextNode("Uredi ime in e-naslov");
        ...
        $element_CELogin = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem8;$node9 = document.createTextNode("Uporabni");
        $elem8.appendChild($node9);
        ...
        $node10 = document.createTextNode("Ime");
        ...
        $node10 = document.createTextNode("E-naslov");
        $elem9.appendChild($node10);
        ...
        $attr8 = document.createAttributeNS("", "value");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("Shrani spremembe");
        $attr8.appendChild($node9);
        ...
        $node8 = document.createTextNode("Pridru\u017ei se/zapusti skupino");
        $elem7.appendChild($node8);
        ...
        $element_AGLogin = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem8;$node9 = document.createTextNode("Uporabni");
        $elem8.appendChild($node9);
        ...
        $node10 = document.createTextNode("Geslo skupine");
        $elem9.appendChild($node10);
        ...
        $attr8 = document.createAttributeNS("", "value");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("Pridru\u017ei se");
        $attr8.appendChild($node9);
        ...
        $attr8 = document.createAttributeNS("", "value");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("Zapusti");
        $attr8.appendChild($node9);
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("return confirm('\u00cates-vous s\u00fbr de vouloir izbri\u0161i obstoje\u010dega uporabnika ?')");
        $attr4.appendChild($node5);
        ...
        $element_DLogin = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem8;$node9 = document.createTextNode("Uporabni");
        $elem8.appendChild($node9);
        ...
        $node10 = document.createTextNode("Geslo");
        $elem9.appendChild($node10);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $node5 = document.createTextNode("Seznam skupin");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("Skupine :");
        $elem4.appendChild($node5);
        ...
        $element_GroupList = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem4;$node5 = document.createTextNode("Skupine");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("Spremeni geslo");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("Uporabni");
        $elem4.appendChild($node5);
        
        $node5 = document.createEntityReference("scaron");
        $elem4.appendChild($node5);
        
        $node6 = document.createTextNode("\u0161");
        $node5.appendChild($node6);
        
        $node5 = document.createTextNode("ko ime");
        $elem4.appendChild($node5);
        ...
        $element_CPLogin = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem4;$node5 = document.createTextNode("Uporabni");
        $elem4.appendChild($node5);
        ...
        $node6 = document.createTextNode("Novo geslo");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("Potrdi novo geslo");
        $elem5.appendChild($node6);
        ...
        $attr4 = document.createAttributeNS("", "value");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Shrani spremembe");
        $attr4.appendChild($node5);
