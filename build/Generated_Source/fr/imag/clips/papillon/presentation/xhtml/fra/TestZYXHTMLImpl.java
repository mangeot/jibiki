 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/fra/TestZY.xhtml
 */
public class TestZYXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements TestZYXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.TestZYXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_Auteur;
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_LangueCible;

    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_Login;

    private org.enhydra.xml.xhtml.dom.XHTMLDivElement $element_MySearchTest;

    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_Name;

    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_NameDico;

    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_Pois1;

    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_Pois2;

    private org.enhydra.xml.xhtml.dom.XHTMLTableRowElement $element_ResultRow;
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/fra/TestZY.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("User Test");
        ...
        $attr3 = document.createAttributeNS("", "id");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("MySearchTest");
        $attr3.appendChild($node4);
        ...
        $element_MySearchTest = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem3;$node4 = document.createTextNode("\n");
        $elem3.appendChild($node4);
        
        $elem4 = document.createElementNS("http://www.w3.org/1999/xhtml", "h2");
        $elem3.appendChild($elem4);
        
        $node5 = document.createTextNode("Consultation Test");
        $elem4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "summary");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("SearchTest");
        $attr4.appendChild($node5);
        ...
        $node7 = document.createTextNode("Nom de dico");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "th");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Pois1");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "th");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Pois2");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "th");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Langue cible");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "th");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Auteur");
        $elem6.appendChild($node7);
        ...
        $attr5 = document.createAttributeNS("", "id");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("ResultRow");
        $attr5.appendChild($node6);
        
        $element_ResultRow = (org.enhydra.xml.xhtml.dom.XHTMLTableRowElement)$elem5;$elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "td");
        $elem5.appendChild($elem6);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("NameDico");
        $attr7.appendChild($node8);
        
        $element_NameDico = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem7;$node8 = document.createTextNode("name");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Pois1");
        $attr7.appendChild($node8);
        
        $element_Pois1 = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem7;$node8 = document.createTextNode("p1");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Pois2");
        $attr7.appendChild($node8);
        
        $element_Pois2 = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem7;$node8 = document.createTextNode("p2");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("LangueCible");
        $attr7.appendChild($node8);
        
        $element_LangueCible = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem7;$node8 = document.createTextNode("lc");
        $elem7.appendChild($node8);
        ...
        $element_Auteur = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem7;$node8 = document.createTextNode("auteur");
        $elem7.appendChild($node8);
    ...
    /**
     * Get the element with id <CODE>Auteur</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLSpanElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLSpanElement getElementAuteur() {
        return $element_Auteur;
    }
    ...
    /**
     * Get the element with id <CODE>LangueCible</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLSpanElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLSpanElement getElementLangueCible() {
        return $element_LangueCible;
    }
    ...
    /**
     * Get the element with id <CODE>MySearchTest</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLDivElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLDivElement getElementMySearchTest() {
        return $element_MySearchTest;
    }
    ...
    /**
     * Get the element with id <CODE>NameDico</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLSpanElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLSpanElement getElementNameDico() {
        return $element_NameDico;
    }

    /**
     * Get the element with id <CODE>Pois1</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLSpanElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLSpanElement getElementPois1() {
        return $element_Pois1;
    }

    /**
     * Get the element with id <CODE>Pois2</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLSpanElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLSpanElement getElementPois2() {
        return $element_Pois2;
    }

    /**
     * Get the element with id <CODE>ResultRow</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLTableRowElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLTableRowElement getElementResultRow() {
        return $element_ResultRow;
    }
     ...
     */
    public org.w3c.dom.Element getTagAuteur() {
        return $element_Auteur;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagLangueCible() {
        return $element_LangueCible;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagMySearchTest() {
        return $element_MySearchTest;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagNameDico() {
        return $element_NameDico;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagPois1() {
        return $element_Pois1;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagPois2() {
        return $element_Pois2;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagResultRow() {
        return $element_ResultRow;
    }
    ...
    /**
     * Get the value of text child of element <CODE>Auteur</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextAuteur(String text) {
        doSetText($element_Auteur, text);
    }
    ...
    /**
     * Get the value of text child of element <CODE>LangueCible</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextLangueCible(String text) {
        doSetText($element_LangueCible, text);
    }
    ...
    /**
     * Get the value of text child of element <CODE>MySearchTest</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextMySearchTest(String text) {
        doSetText($element_MySearchTest, text);
    }
    ...
    /**
     * Get the value of text child of element <CODE>NameDico</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextNameDico(String text) {
        doSetText($element_NameDico, text);
    }

    /**
     * Get the value of text child of element <CODE>Pois1</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextPois1(String text) {
        doSetText($element_Pois1, text);
    }

    /**
     * Get the value of text child of element <CODE>Pois2</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextPois2(String text) {
        doSetText($element_Pois2, text);
    }
