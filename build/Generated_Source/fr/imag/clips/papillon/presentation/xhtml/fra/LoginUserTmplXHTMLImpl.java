 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/fra/LoginUserTmpl.xhtml
 */
public class LoginUserTmplXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LoginUserTmplXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.LoginUserTmplXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/fra/LoginUserTmpl.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("Page d'enregistrement");
        ...
        $node10 = document.createTextNode("Mot de ");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("asse");
        $elem9.appendChild($node10);
        ...
        $node9 = document.createTextNode("Garder mon login avec un cookie d'un an");
        ...
        $node5 = document.createTextNode("Si vous \u00eates un nouvel utilisateur, veuillez vous\n");
        $elem4.appendChild($node5);
        ...
        $node6 = document.createTextNode(" enregistrer ");
        $elem5.appendChild($node6);
        
        $node5 = document.createTextNode(" auparavant.");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("Si vous avez oubli\u00e9 votre login ou votre mot de passe, ");
        $elem4.appendChild($node5);
        ...
        $node6 = document.createTextNode("cliquez ici !");
        $elem5.appendChild($node6);
