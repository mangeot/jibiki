 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/orig/MergeEntries.xhtml
 */
public class MergeEntriesXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements MergeEntriesXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    private org.enhydra.xml.xhtml.dom.XHTMLDivElement $element_EntriesView;

    private org.enhydra.xml.xhtml.dom.XHTMLDivElement $element_MergeEntriesContent;

    private org.enhydra.xml.xhtml.dom.XHTMLDivElement $element_MergingResultView;
    ...
    /**
     * Class attribute constant for element class mergingResultTitle
     */
    public static final String CLASS_mergingResultTitle = "mergingResultTitle";
     ...
     */
    public static final Class XMLC_GENERATED_CLASS = MergeEntriesXHTMLImpl.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class can be regenerated from.
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/orig/MergeEntries.xhtml";
     ...
     */
    public MergeEntriesXHTMLImpl(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     * Copy constructor.
     */
    public MergeEntriesXHTMLImpl(MergeEntriesXHTMLImpl src) {
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("MergeEntriesContent");
        $attr3.appendChild($node4);
        ...
        $element_MergeEntriesContent = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem3;$node4 = document.createTextNode("\n            ");
        ...
        $node5 = document.createTextNode("mergingResultTitle");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Some axies were merged to your edited axie. Result is:");
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("MergingResultView");
        $attr4.appendChild($node5);
        
        $element_MergingResultView = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem4;$node4 = document.createTextNode("\n            ");
        $elem3.appendChild($node4);
        ...
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Undo");
        $attr6.appendChild($node7);
        ...
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("top.window.close();");
        $attr6.appendChild($node7);
        ...
        $node5 = document.createTextNode("Merged axies:");
        $elem4.appendChild($node5);
        ...
        $node6 = document.createTextNode("editingResultView");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "id");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("EntriesView");
        $attr5.appendChild($node6);
        
        $element_EntriesView = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem5;$node5 = document.createTextNode("\n            ");
        $elem4.appendChild($node5);
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new MergeEntriesXHTMLImpl(this);
    }
    ...
    /**
     * Get the element with id <CODE>EntriesView</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLDivElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLDivElement getElementEntriesView() {
        return $element_EntriesView;
    }

    /**
     * Get the element with id <CODE>MergeEntriesContent</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLDivElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLDivElement getElementMergeEntriesContent() {
        return $element_MergeEntriesContent;
    }

    /**
     * Get the element with id <CODE>MergingResultView</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLDivElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLDivElement getElementMergingResultView() {
        return $element_MergingResultView;
    }
     ...
     */
    public org.w3c.dom.Element getTagEntriesView() {
        return $element_EntriesView;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagMergeEntriesContent() {
        return $element_MergeEntriesContent;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagMergingResultView() {
        return $element_MergingResultView;
    }
    ...
    /**
     * Get the value of text child of element <CODE>EntriesView</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextEntriesView(String text) {
        doSetText($element_EntriesView, text);
    }

    /**
     * Get the value of text child of element <CODE>MergeEntriesContent</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextMergeEntriesContent(String text) {
        doSetText($element_MergeEntriesContent, text);
    }

    /**
     * Get the value of text child of element <CODE>MergingResultView</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextMergingResultView(String text) {
        doSetText($element_MergingResultView, text);
    }
