 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/fra/AdvancedQueryForm.xhtml
 */
public class AdvancedQueryFormXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdvancedQueryFormXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.AdvancedQueryFormXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/fra/AdvancedQueryForm.xhtml";
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $node6 = document.createTextNode("Consulter :");
        $elem5.appendChild($node6);
        ...
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("tous dictionnaires");
        $attr6.appendChild($node7);
        ...
        $element_DictionaryTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("tous dictionnaires");
        $elem6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "label");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("tous volumes");
        $attr6.appendChild($node7);
        ...
        $element_VolumeTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("tous volumes");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("o\u00f9 :");
        $elem5.appendChild($node6);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("le mot-vedette");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("la variante");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("cdm-headword-variant");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("l'\u00e9criture");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("cdm-writing");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("la classe");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("un exemple");
        $attr7.appendChild($node8);
        ...
        $node7 = document.createComment("option value=\"cdm-definition\" label=\"la definition\">la d\u00e9finition</option");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("cr\u00e9\u00e9 par");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("\u00e0 (aaaa/mm/jj)");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("cdm-contribution-creation-date");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("modifi\u00e9 par");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("le statut");
        $attr7.appendChild($node8);
        ...
        $node8 = document.createTextNode("le status");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("l'id de l'entr\u00e9e");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("l'id de la contrib");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("le niveau");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("cdm-contribution-group");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("est");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("comme");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("commence par");
        $attr7.appendChild($node8);
        ...
        $node7 = document.createComment("option value=\"5\" label=\"finit par\">finit par</option>\n                      <option value=\"4\" label=\"contient\">contient</option");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("plus grand que");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("plus petit que");
        $attr7.appendChild($node8);
        ...
        $attr8 = document.createAttributeNS("", "label");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("Toutes");
        $attr8.appendChild($node9);
        ...
        $node6 = document.createTextNode("Voir les langues cibles :");
        $elem5.appendChild($node6);
        ...
        $attr6 = document.createAttributeNS("", "label");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Toutes");
        $attr6.appendChild($node7);
        ...
        $element_TargetTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("Toutes");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("Recherche rapide :");
        $elem5.appendChild($node6);
        ...
        $element_MyFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("Mes contributions finies");
        $elem5.appendChild($node6);
        ...
        $element_MyNotFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("Mes contributions non finies");
        $elem5.appendChild($node6);
