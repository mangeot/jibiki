 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/orig/ChooseEntryTmpl.xhtml
 */
public class ChooseEntryTmplXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements ChooseEntryTmplXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_EntryListButton;

    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_EntryListCell;
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_Redirection;

    /**
     * Element name constant for Choose
     */
    ...
    /**
     * Element name constant for Redirection
     */
    public static final String NAME_Redirection = "Redirection";

    /**
     * Field that is used to identify this as the XMLC generated class
     * in an inheritance chain. Contains a reference to the class object.
     */
    public static final Class XMLC_GENERATED_CLASS = ChooseEntryTmplXHTMLImpl.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class can be regenerated from.
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/orig/ChooseEntryTmpl.xhtml";
     ...
     * Default constructor.
     */
    public ChooseEntryTmplXHTMLImpl() {
        buildDocument();
    }
     ...
     */
    public ChooseEntryTmplXHTMLImpl(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     * Copy constructor.
     */
    public ChooseEntryTmplXHTMLImpl(ChooseEntryTmplXHTMLImpl src) {
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("Choose an entry");
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("ChooseEntry.po");
        $attr4.appendChild($node5);
        ...
        $node7 = document.createTextNode("Redirection");
        ...
        $element_Redirection = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem6;$node6 = document.createTextNode("\n");
        $elem5.appendChild($node6);
        ...
        $node9 = document.createTextNode("Choose");
        $elem8.appendChild($node9);
        
        $elem8 = document.createElementNS("http://www.w3.org/1999/xhtml", "th");
        $elem7.appendChild($elem8);
        
        $node9 = document.createTextNode("Entry");
        $elem8.appendChild($node9);
        ...
        $node10 = document.createTextNode("Choose");
        ...
        $node8 = document.createTextNode("EntryListRow");
        $attr7.appendChild($node8);
        
        $element_EntryListRow = (org.enhydra.xml.xhtml.dom.XHTMLTableRowElement)$elem7;$elem8 = document.createElementNS("http://www.w3.org/1999/xhtml", "td");
        $elem7.appendChild($elem8);
        ...
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("EntryListButton");
        $attr9.appendChild($node10);
        
        $attr9 = document.createAttributeNS("", "name");
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("EntryId");
        $attr9.appendChild($node10);
        
        $attr9 = document.createAttributeNS("", "type");
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("radio");
        $attr9.appendChild($node10);
        
        $element_EntryListButton = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem9;$elem8 = document.createElementNS("http://www.w3.org/1999/xhtml", "td");
        $elem7.appendChild($elem8);
        ...
        $attr9 = document.createAttributeNS("", "id");
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("EntryListCell");
        $attr9.appendChild($node10);
        
        $element_EntryListCell = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem9;$node4 = document.createTextNode("\n");
        $elem3.appendChild($node4);
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new ChooseEntryTmplXHTMLImpl(this);
    }
    ...
    /**
     * Get the element with id <CODE>EntryListButton</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementEntryListButton() {
        return $element_EntryListButton;
    }

    /**
     * Get the element with id <CODE>EntryListCell</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLSpanElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLSpanElement getElementEntryListCell() {
        return $element_EntryListCell;
    }
    ...
    /**
     * Get the element with id <CODE>Redirection</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementRedirection() {
        return $element_Redirection;
    }
     ...
     */
    public org.w3c.dom.Element getTagEntryListButton() {
        return $element_EntryListButton;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagEntryListCell() {
        return $element_EntryListCell;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagRedirection() {
        return $element_Redirection;
    }

    /**
     * Get the value of text child of element <CODE>EntryListCell</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextEntryListCell(String text) {
        doSetText($element_EntryListCell, text);
    }
