 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/orig/AdminVolumes.xhtml
 */
public class AdminVolumesXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdminVolumesXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/orig/AdminVolumes.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node5 = document.createTextNode("Manage the XML Volumes");
        ...
        $node9 = document.createTextNode("Load Also Entries: ");
        $elem8.appendChild($node9);
        ...
        $node6 = document.createTextNode("After importing data, do not forget to ");
        ...
        $node7 = document.createTextNode("Admin.po");
        $attr6.appendChild($node7);
        
        $node7 = document.createTextNode("reindex");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(" your volume!");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("NB: The Volume Metadata file must be valid against the <volume-metadata> element of the DML schema. The latest version of the schema can be found at: ");
        $elem5.appendChild($node6);
        ...
        $node10 = document.createTextNode("Interface File");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("All volumes");
        $elem9.appendChild($node10);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $node3 = document.createTextNode("Src");
        $elem2.appendChild($node3);
        
        $elem2 = document.createElementNS("http://www.w3.org/1999/xhtml", "th");
        $elem1.appendChild($elem2);
        
        $node3 = document.createTextNode("Entries");
        $elem2.appendChild($node3);
        ...
        $node3 = document.createTextNode("Metatada");
        $elem2.appendChild($node3);
        
        $elem2 = document.createElementNS("http://www.w3.org/1999/xhtml", "th");
        $elem1.appendChild($elem2);
        
        $node3 = document.createTextNode("All");
        $elem2.appendChild($node3);
        ...
        $element_SeeSchema = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem4;$node5 = document.createTextNode("See");
        $elem4.appendChild($node5);
        ...
        $element_SeeTemplate = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem4;$node5 = document.createTextNode("See");
        $elem4.appendChild($node5);
        ...
        $element_SeeInterface = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem4;$node5 = document.createTextNode("See");
        $elem4.appendChild($node5);
