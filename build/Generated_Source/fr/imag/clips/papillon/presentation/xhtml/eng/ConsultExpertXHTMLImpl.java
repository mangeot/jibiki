 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtml/eng/ConsultExpert.xhtml
 */
public class ConsultExpertXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements ConsultExpertXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.ConsultExpertXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtml/eng/ConsultExpert.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $element_SorryMessage = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem4;$node5 = document.createTextNode("Sorry, this entry does not exist yet, You can contribute by ");
        ...
        $node6 = document.createTextNode("adding");
        $elem5.appendChild($node6);
        
        $node5 = document.createTextNode(" it to the dictionary !");
        $elem4.appendChild($node5);
        ...
        $element_EntryIdList = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem8;$node9 = document.createTextNode("EntryIdList");
        $elem8.appendChild($node9);
        ...
        $node9 = document.createTextNode("Writing");
        $elem8.appendChild($node9);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $element_Search1text = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem4;$node4 = document.createTextNode(" is \n              ");
        $elem3.appendChild($node4);
        ...
        $attr5 = document.createAttributeNS("", "label");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("lemmatize");
        $attr5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "label");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("foks");
        $attr5.appendChild($node6);
        ...
        $node6 = document.createTextNode("FOKS Japanese");
        $elem5.appendChild($node6);
        
        $node4 = document.createTextNode(" of the\n             ");
        $elem3.appendChild($node4);
        ...
        $attr5 = document.createAttributeNS("", "label");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("pronunciation");
        $attr5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "label");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("reading");
        $attr5.appendChild($node6);
        ...
        $node4 = document.createTextNode(" and ");
        $elem3.appendChild($node4);
        ...
        $element_Search2text = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem4;$node4 = document.createTextNode(" is\n              ");
        $elem3.appendChild($node4);
