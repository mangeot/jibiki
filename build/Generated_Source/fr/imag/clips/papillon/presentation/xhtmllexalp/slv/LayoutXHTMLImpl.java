 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/slv/Layout.xhtml
 */
public class LayoutXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LayoutXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.LayoutXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/slv/Layout.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node4 = document.createTextNode("Plate-forme LexALP");
        ...
        $element_Logo = (org.enhydra.xml.xhtml.dom.XHTMLImageElement)$elem6;$node5 = document.createTextNode(" Terminolo");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("ki bazi ");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createComment("\u00a0|\u00a0<a href=\"Search.po\">iskanje</a>\u00a0|\u00a0<a href=\"SiteMap.po\">kazalo spletne strani</a>");
        $elem4.appendChild($node5);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Page Web du Programme Espace Alpin");
        $attr5.appendChild($node6);
        ...
        $node4 = document.createTextNode("\n        Plate-forme: \u00a9 2001-2007, GETA-CLIPS, GETALP-LIG. Tous droits r\u00e9serv\u00e9s.");
        $elem3.appendChild($node4);
        
        $elem4 = document.createElementNS("http://www.w3.org/1999/xhtml", "br");
        $elem3.appendChild($elem4);
        
        $node4 = document.createTextNode("\n        Donn\u00e9es: \u00a9 2005-2007 projet LexALP Interreg IIIb.");
        $elem3.appendChild($node4);
