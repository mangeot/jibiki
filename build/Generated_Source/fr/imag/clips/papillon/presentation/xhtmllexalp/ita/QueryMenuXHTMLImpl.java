 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/ita/QueryMenu.xhtml
 */
public class QueryMenuXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements QueryMenuXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.QueryMenuXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/ita/QueryMenu.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Cerca un termine nella banca dati");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Ricerca semplice:");
        ...
        $node10 = document.createTextNode("ermine:");
        ...
        $node10 = document.createTextNode("ingua di partenza:");
        $elem9.appendChild($node10);
        ...
        $element_SourceOptionTemplate = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem10;$node11 = document.createTextNode("NESSUNA");
        $elem10.appendChild($node11);
        ...
        $node10 = document.createTextNode("Lingua di ");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("rrivo:");
        $elem9.appendChild($node10);
        ...
        $element_QMAllTargetsOption = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem10;$node11 = document.createTextNode("Tutte le lingue");
        $elem10.appendChild($node11);
        ...
        $element_TargetTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem10;$node11 = document.createTextNode("NESSUNA");
        $elem10.appendChild($node11);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Cerca");
        $attr7.appendChild($node8);
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Cerca un termine definendo pi\u00f9 parametri");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Ricerca avanzata");
        $elem4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "href");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("DictionaryIndexBrowser.po");
        $attr4.appendChild($node5);
        
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Browse Dictionary Index");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("DICTIONARY INDEX");
        $elem4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Numero di schede per ogni lingua");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Lista schede per lingua");
        $elem4.appendChild($node5);
