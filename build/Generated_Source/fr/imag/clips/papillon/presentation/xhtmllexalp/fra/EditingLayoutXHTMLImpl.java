 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/fra/EditingLayout.xhtml
 */
public class EditingLayoutXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements EditingLayoutXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.EditingLayoutXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/fra/EditingLayout.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node4 = document.createTextNode("Interface d'\u00e9dition LexALP");
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("mailto:Francis.Brunet-ManquatATimag.fr?subject=JibikiServer&body=remplacer\u00a0AT\u00a0par\u00a0@\u00a0dans\u00a0l'addresse\u00a0m\u00e9l.");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "href");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("mailto:Mathieu.MangeotATuniv-savoie.fr?subject=GDEFServer&body=remplacer\u00a0AT\u00a0par\u00a0@\u00a0dans\u00a0l'addresse\u00a0m\u00e9l.");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "href");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("mailto:gilles.serassetATimag.fr?subject=PapillonServer&body=remplacer\u00a0AT\u00a0par\u00a0@\u00a0dans\u00a0l'addresse\u00a0m\u00e9l.");
        $attr4.appendChild($node5);
