 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/eng/HomeContent.xhtml
 */
public class HomeContentXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements HomeContentXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.HomeContentXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/eng/HomeContent.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node6 = document.createTextNode("Welcome to the LexALP Term Bank");
        ...
        $node6 = document.createTextNode("This term bank contains specialised terminology for the subject fields \n           ");
        $elem5.appendChild($node6);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "strong");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Spatial Planning");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(" and ");
        $elem5.appendChild($node6);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "strong");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Sustainable Development");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("The terminology is in ");
        $elem5.appendChild($node6);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "strong");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("German, French, Italian and Slovene");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(" \n           (but not in English, even though we provide an English user interface).");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("We choose few concepts, but try to describe those concepts exhaustively for \n           ");
        $elem5.appendChild($node6);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "strong");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("all Legal Systems of the Alps");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(", therefore you will usually get a lot of \n           information on one page if you do not restrict your search.");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("Notice the ");
        $elem5.appendChild($node6);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "strong");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("flags");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(" on the right side of each term \n           (e.g. ");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode(" for the Alpine Convention): \n           they indicate the legal system to which the term belongs. \n           Sometimes the same terms are used at Alpine Convention, EU, International and national level: \n           in such cases the same search term may be displayed up to three or four times, only with different\n           flags and slightly diverging descriptions. We remind you that, though belonging to International \n           law, the Alpine Convention system is described separately to fully meet the needs and achieve the \n           goals of the project.");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("Terms with the label ");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode(" always come in a quartet. There are four terms, \n        one for each language, which are equivalent within the Alpine Convention. \n        The main goal of the LexALP Project is to identify a large number of useful quartets of translation equivalents.");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("The LexALP term bank serves both for the ");
        $elem5.appendChild($node6);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "strong");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("elaboration");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode(" of terminology entries. \n        Your advantage is real-time access to the relevant Alpine Convention terminology, but remember: this is work in progress!");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("If you ");
        $elem5.appendChild($node6);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "strong");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("cannot find");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(" a certain expression, try to look it up in the \n        ");
        $elem5.appendChild($node6);
        
        $node6 = document.createComment(" a title=\"corpus LexALP\"  href=\"http://217.199.4.152:8080/htdocs2/lexalp/corp_lexalp/search_corp.php\" ");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode(", \n        where you might get a translation in a parallel text.");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("You will notice that all terms are classified into ");
        $elem5.appendChild($node6);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "strong");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("domains");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(". All terminology is classified\n        according to a specific structure, inspired by art. 9 of the Alpine Convention Protocol \n        'Spatial Planning and Sustainable Development' (available in \n\t\t");
        $elem5.appendChild($node6);
        ...
        $node7 = document.createTextNode("French");
        $elem6.appendChild($node7);
        ...
        $node7 = document.createTextNode("German");
        $elem6.appendChild($node7);
        ...
        $node7 = document.createTextNode("Italian");
        $elem6.appendChild($node7);
        ...
        $node7 = document.createTextNode("Slovene");
        $elem6.appendChild($node7);
        
        $node6 = document.createTextNode(").\n\t\t\t \n         In your advanced lookup interface you can specify a domain \n        (and many more criteria like language, legal field, legal system, etc.) and restrict your search.");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("For a more ample description in our technical user-guide please click ");
        $elem5.appendChild($node6);
        ...
        $node7 = document.createTextNode("here");
        $elem6.appendChild($node7);
