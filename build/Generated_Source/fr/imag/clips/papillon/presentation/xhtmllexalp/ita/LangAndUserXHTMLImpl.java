 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/ita/LangAndUser.xhtml
 */
public class LangAndUserXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LangAndUserXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.LangAndUserXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/ita/LangAndUser.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("gestione informazioni utente");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Utente:");
        ...
        $element_UserLogin = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem4;$node5 = document.createTextNode("login utente");
        $elem4.appendChild($node5);
        ...
        $node7 = document.createTextNode("ingua:");
        $elem6.appendChild($node7);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("accedi come utente registrato");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("entra");
        $elem5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("mostra/modifica nome utente/password/indirizzo...");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("profilo utente");
        $elem5.appendChild($node6);
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("return confirm('Sei sicuro di volere uscire dalla banca dati?')");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("esci dall'area riservata");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("esci");
        $elem5.appendChild($node6);
