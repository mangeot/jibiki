 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/deu/Layout.xhtml
 */
public class LayoutXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LayoutXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.LayoutXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/deu/Layout.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node4 = document.createTextNode("LexALP Information System");
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("de");
        $attr4.appendChild($node5);
        ...
        $element_Logo = (org.enhydra.xml.xhtml.dom.XHTMLImageElement)$elem6;$node5 = document.createTextNode(" Terminologiedatenbank ");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createComment("\u00a0|\u00a0<a href=\"Search.po\">Search</a>\u00a0|\u00a0<a href=\"SiteMap.po\">Seiten&uuml;bersicht</a>");
        $elem4.appendChild($node5);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Alpenraumprogrammwebseite");
        $attr5.appendChild($node6);
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("http://www.mozilla-europe.org/de/");
        $attr4.appendChild($node5);
        ...
        $node5 = document.createTextNode("The LexALP Term Bank is optimized for the freely available browser: ");
        $elem4.appendChild($node5);
        ...
        $node4 = document.createTextNode("\n        Plattform: \u00a9 2001-2007, GETA-CLIPS, GETALP-LIG. Alle Rechte vorbehalten.");
        $elem3.appendChild($node4);
        
        $elem4 = document.createElementNS("http://www.w3.org/1999/xhtml", "br");
        $elem3.appendChild($elem4);
        
        $node4 = document.createTextNode("\n        Data: \u00a9 2005-2007 LexALP Interreg IIIb project.");
        $elem3.appendChild($node4);
