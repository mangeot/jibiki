 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/slv/LangAndUser.xhtml
 */
public class LangAndUserXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LangAndUserXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.LangAndUserXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/slv/LangAndUser.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Gestion d\u2019un utilisateur");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("uporabnik");
        ...
        $element_UserLogin = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem4;$node5 = document.createTextNode("Uporabni\u0161ko ime");
        $elem4.appendChild($node5);
        ...
        $node8 = document.createTextNode("J");
        $elem7.appendChild($node8);
        
        $node7 = document.createTextNode("ezik");
        $elem6.appendChild($node7);
        ...
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("i\u0161\u010di");
        $attr8.appendChild($node9);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Se loguer sur le serveur Papillon");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("prijava");
        $elem5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Voir/modifier son profil utilisateur");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("uporabni");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("ki profil");
        $elem5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Se d\u00e9loguer du serveur Papillon");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("odjava");
        $elem5.appendChild($node6);
