 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/deu/QueryMenu.xhtml
 */
public class QueryMenuXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements QueryMenuXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.QueryMenuXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/deu/QueryMenu.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node6 = document.createTextNode("Suche:");
        ...
        $node8 = document.createComment("div class=\"menuVariableName\"");
        $elem7.appendChild($node8);
        ...
        $node9 = document.createTextNode("float: left; width: 60px;");
        ...
        $node10 = document.createTextNode("erminus:");
        ...
        $node8 = document.createComment("div class=\"menuVariableValue\" ");
        $elem7.appendChild($node8);
        ...
        $attr8 = document.createAttributeNS("", "style");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("float: left; width: 80px;");
        $attr8.appendChild($node9);
        ...
        $attr8 = document.createAttributeNS("", "style");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("float: left; width: 90px;");
        $attr8.appendChild($node9);
        ...
        $node10 = document.createTextNode("usgangssprache:");
        $elem9.appendChild($node10);
        ...
        $attr8 = document.createAttributeNS("", "style");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("float: left; width: 50px;");
        $attr8.appendChild($node9);
        ...
        $attr8 = document.createAttributeNS("", "style");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("float: left; width: 70px;");
        $attr8.appendChild($node9);
        ...
        $attr9 = document.createAttributeNS("", "accesskey");
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("z");
        $attr9.appendChild($node10);
        ...
        $node11 = document.createTextNode("Z");
        $elem10.appendChild($node11);
        
        $node10 = document.createTextNode("ielsprache:");
        $elem9.appendChild($node10);
        ...
        $element_QMAllTargetsOption = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem10;$node11 = document.createTextNode("alles");
        $elem10.appendChild($node11);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Suche");
        $attr7.appendChild($node8);
        ...
        $node5 = document.createTextNode("Expertensuche");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("Liste der W\u00f6rterb\u00fccher");
        $elem4.appendChild($node5);
