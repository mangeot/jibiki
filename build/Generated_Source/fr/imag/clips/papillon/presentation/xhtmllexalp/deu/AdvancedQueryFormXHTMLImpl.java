 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/deu/AdvancedQueryForm.xhtml
 */
public class AdvancedQueryFormXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdvancedQueryFormXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.AdvancedQueryFormXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/deu/AdvancedQueryForm.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node7 = document.createTextNode("Ergebnisse im Dateiformat:");
        $elem6.appendChild($node7);
        ...
        $node8 = document.createTextNode("Standard");
        $elem7.appendChild($node8);
        ...
        $node7 = document.createTextNode("anzeigen");
        $elem6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Suche");
        $attr6.appendChild($node7);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $node8 = document.createTextNode("Terminus");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Grammatik");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Kontext");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Kommentar");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Quelle");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Rechtssystem");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Fachgebiet");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("territorialer Gebrauch");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Autor letzte ");
        $elem7.appendChild($node8);
        
        $node8 = document.createEntityReference("Auml");
        $elem7.appendChild($node8);
        
        $node9 = document.createTextNode("\u00c4");
        $node8.appendChild($node9);
        
        $node8 = document.createTextNode("nderung");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Datum");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Harmonisierungsstatus");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Bearbeitungsstatus");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Eintragsstatus");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Eintragsnummer");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("enth");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("lt");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("ist");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("beginnt mit");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("endet auf");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("gr");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createEntityReference("szlig");
        $elem7.appendChild($node8);
        
        $node9 = document.createTextNode("\u00df");
        $node8.appendChild($node9);
        
        $node8 = document.createTextNode("er als");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("kleiner als");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Ausgangssprache:");
        $elem7.appendChild($node8);
        ...
        $node9 = document.createTextNode("alle Sprachen");
        ...
        $node6 = document.createTextNode("Zielsprachen :");
        $elem5.appendChild($node6);
        ...
        $element_TargetTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("alles");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("Schnellsuche :");
        $elem5.appendChild($node6);
        ...
        $element_MyFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("Meine vollst");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("ndigen Eintr");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("ge");
        $elem5.appendChild($node6);
        ...
        $element_MyNotFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("Meine tempor");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("ren Eintr");
        $elem5.appendChild($node6);
