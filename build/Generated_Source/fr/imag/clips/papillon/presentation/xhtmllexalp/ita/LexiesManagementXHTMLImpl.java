 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/ita/LexiesManagement.xhtml
 */
public class LexiesManagementXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LexiesManagementXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.LexiesManagementXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/ita/LexiesManagement.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node6 = document.createTextNode("Schede:");
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Create una nuova scheda");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Crea nuova");
        $elem4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Modifica le schede esistenti");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Modifica");
        $elem4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Esporta schede in formato pdf");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Esporta");
        $elem4.appendChild($node5);
