 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/ita/AdvancedQueryForm.xhtml
 */
public class AdvancedQueryFormXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdvancedQueryFormXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.AdvancedQueryFormXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/ita/AdvancedQueryForm.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node7 = document.createTextNode("Mostra");
        ...
        $node8 = document.createTextNode("tutti");
        $elem7.appendChild($node8);
        ...
        $node7 = document.createTextNode("risultati per pagina usando il formato:");
        $elem6.appendChild($node7);
        ...
        $element_XslTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem7;$node8 = document.createTextNode("standard");
        $elem7.appendChild($node8);
        ...
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Cerca");
        $attr6.appendChild($node7);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $node6 = document.createTextNode("Trova schede in:");
        $elem5.appendChild($node6);
        ...
        $element_DictionaryTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("Tutti i dizionari");
        $elem6.appendChild($node7);
        ...
        $node8 = document.createTextNode("definizione");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("grammatica");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("contesto");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("nota");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("fonte");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("ordinamento");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("numero dominio");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("uso geografico");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("modificato da");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("creato da");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("status dell'armonizzazione");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("numero della scheda");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("contiene");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("\u00e8");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("inizia con");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("termina con");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("\u00e8 maggiore di");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("\u00e8 minore di");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("lingua di partenza:");
        $elem7.appendChild($node8);
        ...
        $node9 = document.createTextNode("tutte le lingue");
        ...
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("NESSUNA");
        $attr8.appendChild($node9);
        ...
        $element_SourceOptionTemplate = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem8;$node9 = document.createTextNode("NESSUNA");
        $elem8.appendChild($node9);
        ...
        $node6 = document.createTextNode("Mostra lingue di arrivo:");
        $elem5.appendChild($node6);
        ...
        $element_TargetTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("tutte le lingue");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("Ricerca rapida:");
        $elem5.appendChild($node6);
        ...
        $element_MyFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("le mie schede terminate");
        $elem5.appendChild($node6);
        ...
        $element_MyNotFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("le mie schede da aggiornare");
        $elem5.appendChild($node6);
