 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/slv/QueryMenu.xhtml
 */
public class QueryMenuXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements QueryMenuXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.QueryMenuXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/slv/QueryMenu.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node6 = document.createTextNode("Iskanje");
        ...
        $node10 = document.createTextNode("ermin");
        ...
        $node10 = document.createTextNode("zvirni jezik");
        $elem9.appendChild($node10);
        ...
        $node10 = document.createTextNode("iljni jezik");
        $elem9.appendChild($node10);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("i\u0161\u010di");
        $attr7.appendChild($node8);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Parcourir les entr\u00e9es des dictionnaires");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Index des dictionnaires");
        $elem4.appendChild($node5);
        ...
        $node5 = document.createTextNode("Neznam slovarjev");
        $elem4.appendChild($node5);
