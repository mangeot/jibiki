 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmllexalp/slv/AdvancedQueryForm.xhtml
 */
public class AdvancedQueryFormXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdvancedQueryFormXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.AdvancedQueryFormXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmllexalp/slv/AdvancedQueryForm.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node7 = document.createTextNode("Poka\u017ei ");
        ...
        $node8 = document.createTextNode("vsi");
        $elem7.appendChild($node8);
        ...
        $node7 = document.createTextNode("zadetkov na stran v obliki:");
        $elem6.appendChild($node7);
        ...
        $node8 = document.createTextNode("Privzeto");
        $elem7.appendChild($node8);
        ...
        $element_XslTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem7;$node8 = document.createTextNode("Privzeto");
        $elem7.appendChild($node8);
        ...
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("iskanje");
        $attr6.appendChild($node7);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $node6 = document.createTextNode("najdi vnose v: ");
        $elem5.appendChild($node6);
        ...
        $element_DictionaryTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("Tous les dictionnaires");
        $elem6.appendChild($node7);
        ...
        $node8 = document.createTextNode("cdm-vedette");
        $elem7.appendChild($node8);
        ...
        $element_Tmp = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem5;$node6 = document.createTextNode("\n                    ");
        $elem5.appendChild($node6);
        ...
        $node8 = document.createTextNode("Termin");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Grammaire");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("lexalp-phraseological-unit");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("PHRASEOLOGICAL UNIT");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Syst\u00e8me juridique");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Zone g\u00e9ographique d'emploi");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Cr\u00e9e par");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("Statut de l'harmonisation");
        $elem7.appendChild($node8);
        ...
        $node7 = document.createComment("<option value=\"cdm-contribution-id\" label=\"Entry Id\">Id de la contribution</option>");
        $elem6.appendChild($node7);
        ...
        $node8 = document.createTextNode("vsebuje");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("je");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("se za\u010dne z");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("se kon\u010da z");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("ve\u010dji kot");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("manj");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("i kot");
        $elem7.appendChild($node8);
        ...
        $node8 = document.createTextNode("izvirni jezik:");
        $elem7.appendChild($node8);
        ...
        $node9 = document.createTextNode("vsi jeziki");
        ...
        $node6 = document.createTextNode("S\u00e9lectionner les langues cibles\u00a0:");
        $elem5.appendChild($node6);
        ...
        $element_TargetTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("vsi jeziki");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("Hitro iskanje\u00a0:");
        $elem5.appendChild($node6);
        ...
        $element_MyFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("Moji kon\u010dani vnosi");
        $elem5.appendChild($node6);
        ...
        $element_MyNotFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("Moji nedokon\u010dani vnosi");
        $elem5.appendChild($node6);
