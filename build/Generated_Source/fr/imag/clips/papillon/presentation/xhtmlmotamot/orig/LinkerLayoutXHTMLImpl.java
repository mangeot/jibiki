 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlmotamot/orig/LinkerLayout.xhtml
 */
public class LinkerLayoutXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LinkerLayoutXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.LinkerLayoutXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlmotamot/orig/LinkerLayout.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $attr3 = document.createAttributeNS("", "content");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("Motamot project");
        $attr3.appendChild($node4);
        ...
        $node4 = document.createTextNode("Motamot: link to target");
        ...
        $node4 = document.createComment("\n      \n       function updateParent(lang, eid, sid, aid) {\n        var fieldLang = document.getElementById('fieldLang').value;\n        opener.updateFields(fieldLang, lang);\n        var fieldEid = document.getElementById('fieldEid').value;\n        opener.updateFields(fieldEid, eid);\n        var fieldSid = document.getElementById('fieldSid').value;\n        opener.updateFields(fieldSid, sid);\n        var fieldAid = document.getElementById('fieldAid').value;\n        opener.updateFields(fieldAid, aid);\n \t\tvar fieldLevel = document.getElementById('fieldLevel').value;\t  \n \t\tvar level = document.getElementById('fieldLevelValue').value;\t  \n       opener.updateFields(fieldLevel, level);\n\t\t\n       window.close();\n      }\n      \n//");
        $elem3.appendChild($node4);
