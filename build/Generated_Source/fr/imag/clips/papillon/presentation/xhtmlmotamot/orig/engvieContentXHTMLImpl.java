 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlmotamot/orig/engvieContent.xhtml
 */
public class engvieContentXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements engvieContentXHTML, fr.imag.clips.papillon.presentation.xhtmlmotamot.orig.MotamotContentXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final Class XMLC_GENERATED_CLASS = engvieContentXHTMLImpl.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class can be regenerated from.
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlmotamot/orig/engvieContent.xhtml";
     ...
     */
    public engvieContentXHTMLImpl(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     * Copy constructor.
     */
    public engvieContentXHTMLImpl(engvieContentXHTMLImpl src) {
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node6 = document.createTextNode("Motamot project English-Vietnamese dictionary");
        ...
        $node6 = document.createTextNode("Access to:");
        $elem5.appendChild($node6);
        ...
        $node7 = document.createTextNode("Discussion ");
        ...
        $node7 = document.createTextNode("Home");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("Statistics:");
        $elem5.appendChild($node6);
        ...
        $node7 = document.createTextNode("1 English entry");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "li");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("3 Vietnamese entries");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "li");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("1 bilingual link");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "li");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Last contribution on the 14 july 2009 by Hong Thai NGUYEN");
        $elem6.appendChild($node7);
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new engvieContentXHTMLImpl(this);
    }
