 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlmotamot/orig/HomeContent.xhtml
 */
public class HomeContentXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements HomeContentXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.HomeContentXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlmotamot/orig/HomeContent.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node8 = document.createTextNode("engfra.po?SOURCE.0=fra&TARGETS=eng");
        ...
        $node7 = document.createTextNode("Dictionnaire fran\u00e7ais-japonais ");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "href");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("frajpn.po?SOURCE.0=fra&TARGETS=jpn");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("frajpn");
        $elem7.appendChild($node8);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "li");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("Dictionnaire anglais-japonais ");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "href");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("engjpn.po?SOURCE.0=eng&TARGETS=jpn");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("engjpn");
        $elem7.appendChild($node8);
