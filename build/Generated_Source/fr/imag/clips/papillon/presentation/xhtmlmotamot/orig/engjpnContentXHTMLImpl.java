 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlmotamot/orig/engjpnContent.xhtml
 */
public class engjpnContentXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements engjpnContentXHTML, fr.imag.clips.papillon.presentation.xhtmlmotamot.orig.MotamotContentXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final Class XMLC_GENERATED_CLASS = engjpnContentXHTMLImpl.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class can be regenerated from.
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlmotamot/orig/engjpnContent.xhtml";
     ...
     */
    public engjpnContentXHTMLImpl(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     * Copy constructor.
     */
    public engjpnContentXHTMLImpl(engjpnContentXHTMLImpl src) {
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node6 = document.createTextNode("Motamot project English-Japanese dictionary");
        ...
        $node7 = document.createTextNode("1 French entry");
        $elem6.appendChild($node7);
        
        $elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "li");
        $elem5.appendChild($elem6);
        
        $node7 = document.createTextNode("1 Japanese entry");
        $elem6.appendChild($node7);
        ...
        $node7 = document.createTextNode("Last contribution on the 29 june 2009 by mangeot");
        $elem6.appendChild($node7);
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new engjpnContentXHTMLImpl(this);
    }
