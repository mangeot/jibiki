 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlmotamot/orig/LinkerSearchForm.xhtml
 */
public class LinkerSearchFormXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LinkerSearchFormXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_FieldAid;

    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_FieldEid;

    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_FieldLang;

    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_FieldLevel;

    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_FieldLevelValue;

    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_FieldParent;

    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_FieldSid;

    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_OneSourceLang;
    ...
    /**
     * Element name constant for FIELD_AID
     */
    public static final String NAME_FIELD_AID = "FIELD_AID";

    /**
     * Element name constant for FIELD_EID
     */
    public static final String NAME_FIELD_EID = "FIELD_EID";

    /**
     * Element name constant for FIELD_LANG
     */
    public static final String NAME_FIELD_LANG = "FIELD_LANG";

    /**
     * Element name constant for FIELD_LEVEL
     */
    public static final String NAME_FIELD_LEVEL = "FIELD_LEVEL";

    /**
     * Element name constant for FIELD_LEVEL_VALUE
     */
    public static final String NAME_FIELD_LEVEL_VALUE = "FIELD_LEVEL_VALUE";

    /**
     * Element name constant for FIELD_SID
     */
    public static final String NAME_FIELD_SID = "FIELD_SID";
    ...
    /**
     * Element name constant for SOURCEORIG
     */
    public static final String NAME_SOURCEORIG = "SOURCEORIG";
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlmotamot/orig/LinkerSearchForm.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node7 = document.createTextNode("FieldParent");
        $attr6.appendChild($node7);
        
        $element_FieldParent = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem6;$node7 = document.createTextNode("\n          ");
        ...
        $node8 = document.createTextNode("fieldLang");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "name");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("FIELD_LANG");
        $attr7.appendChild($node8);
        ...
        $element_FieldLang = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem7;$node7 = document.createTextNode("\n          ");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("fieldLevel");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "name");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("FIELD_LEVEL");
        $attr7.appendChild($node8);
        ...
        $element_FieldLevel = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem7;$node7 = document.createTextNode("\n          ");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("fieldLevelValue");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "name");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("FIELD_LEVEL_VALUE");
        $attr7.appendChild($node8);
        ...
        $element_FieldLevelValue = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem7;$node7 = document.createTextNode("\n          ");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("fieldEid");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "name");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("FIELD_EID");
        $attr7.appendChild($node8);
        ...
        $element_FieldEid = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem7;$node7 = document.createTextNode("\n          ");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("fieldSid");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "name");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("FIELD_SID");
        $attr7.appendChild($node8);
        ...
        $element_FieldSid = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem7;$node7 = document.createTextNode("\n          ");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("fieldAid");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "name");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("FIELD_AID");
        $attr7.appendChild($node8);
        ...
        $element_FieldAid = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem7;$node7 = document.createTextNode("\n\t\t");
        $elem6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Motamot");
        $attr6.appendChild($node7);
        ...
        $attr8 = document.createAttributeNS("", "label");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("like");
        $attr8.appendChild($node9);
        ...
        $attr7 = document.createAttributeNS("", "id");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("OneSourceLang");
        $attr7.appendChild($node8);
        ...
        $element_OneSourceLang = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem7;$node7 = document.createTextNode("\n        ");
        $elem6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "name");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("SOURCEORIG");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "style");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("display:none;");
        $attr7.appendChild($node8);
        ...
        $attr6 = document.createAttributeNS("", "value");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Defaut");
        $attr6.appendChild($node7);
    ...
    /**
     * Get the element with id <CODE>fieldAid</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementFieldAid() {
        return $element_FieldAid;
    }

    /**
     * Get the element with id <CODE>fieldEid</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementFieldEid() {
        return $element_FieldEid;
    }

    /**
     * Get the element with id <CODE>fieldLang</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementFieldLang() {
        return $element_FieldLang;
    }

    /**
     * Get the element with id <CODE>fieldLevel</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementFieldLevel() {
        return $element_FieldLevel;
    }

    /**
     * Get the element with id <CODE>fieldLevelValue</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementFieldLevelValue() {
        return $element_FieldLevelValue;
    }

    /**
     * Get the element with id <CODE>FieldParent</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLSpanElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLSpanElement getElementFieldParent() {
        return $element_FieldParent;
    }

    /**
     * Get the element with id <CODE>fieldSid</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementFieldSid() {
        return $element_FieldSid;
    }

    /**
     * Get the element with id <CODE>OneSourceLang</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementOneSourceLang() {
        return $element_OneSourceLang;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagFieldAid() {
        return $element_FieldAid;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagFieldEid() {
        return $element_FieldEid;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagFieldLang() {
        return $element_FieldLang;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagFieldLevel() {
        return $element_FieldLevel;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagFieldLevelValue() {
        return $element_FieldLevelValue;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagFieldParent() {
        return $element_FieldParent;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagFieldSid() {
        return $element_FieldSid;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagOneSourceLang() {
        return $element_OneSourceLang;
    }
    ...
    /**
     * Get the value of text child of element <CODE>FieldParent</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextFieldParent(String text) {
        doSetText($element_FieldParent, text);
    }
