 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlpivax/orig/AdminEntriesTmpl.xhtml
 */
public class AdminEntriesTmplXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdminEntriesTmplXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLTableElement $element_TbJoin;
    ...
    /**
     * Element name constant for deleteOld
     */
    public static final String NAME_deleteOld = "deleteOld";

    /**
     * Element name constant for recursiveRelate
     */
    public static final String NAME_recursiveRelate = "recursiveRelate";
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlpivax/orig/AdminEntriesTmpl.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $attr9 = document.createAttributeNS("", "label");
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("Merge");
        $attr9.appendChild($node10);
        
        $attr9 = document.createAttributeNS("", "value");
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("7");
        $attr9.appendChild($node10);
        
        $node10 = document.createTextNode("Merge to unique(axeme or axie entries only)");
        $elem9.appendChild($node10);
        ...
        $attr8 = document.createAttributeNS("", "id");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("tbJoin");
        $attr8.appendChild($node9);
        
        $attr8 = document.createAttributeNS("", "style");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("display:yes");
        $attr8.appendChild($node9);
        
        $element_TbJoin = (org.enhydra.xml.xhtml.dom.XHTMLTableElement)$elem8;$elem9 = document.createElementNS("http://www.w3.org/1999/xhtml", "tr");
        $elem8.appendChild($elem9);
        ...
        $attr11 = document.createAttributeNS("", "checked");
        $elem11.setAttributeNode($attr11);
        $node12 = document.createTextNode("checked");
        $attr11.appendChild($node12);
        
        $attr11 = document.createAttributeNS("", "name");
        $elem11.setAttributeNode($attr11);
        $node12 = document.createTextNode("deleteOld");
        $attr11.appendChild($node12);
        ...
        $node11 = document.createTextNode("Delete olds");
        ...
        $attr11 = document.createAttributeNS("", "name");
        $elem11.setAttributeNode($attr11);
        $node12 = document.createTextNode("recursiveRelate");
        $attr11.appendChild($node12);
        ...
        $node11 = document.createTextNode("Change related entries");
        $elem10.appendChild($node11);
    ...
    /**
     * Get the element with id <CODE>tbJoin</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLTableElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLTableElement getElementTbJoin() {
        return $element_TbJoin;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagTbJoin() {
        return $element_TbJoin;
    }
