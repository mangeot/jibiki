 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlpivax/orig/Layout.xhtml
 */
public class LayoutXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LayoutXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlpivax/orig/Layout.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $attr3 = document.createAttributeNS("", "type");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("javascript");
        $attr3.appendChild($node4);
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("PIVAX");
        $attr5.appendChild($node6);
        ...
        $element_Logo = (org.enhydra.xml.xhtml.dom.XHTMLImageElement)$elem6;$node5 = document.createTextNode("UNL Dictionary\n      ");
        $elem4.appendChild($node5);
        ...
        $node4 = document.createTextNode("\n        Jibiki Plateform: \u00a9 2001-2008, GETALP-LIG. All rights reserved.");
        $elem3.appendChild($node4);
        
        $elem4 = document.createElementNS("http://www.w3.org/1999/xhtml", "br");
        $elem3.appendChild($elem4);
        
        $node4 = document.createTextNode("\n        Data: \u00a9 2007- PIVAX Project.");
        $elem3.appendChild($node4);
