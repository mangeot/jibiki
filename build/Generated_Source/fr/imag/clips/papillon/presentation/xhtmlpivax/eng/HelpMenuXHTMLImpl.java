 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlpivax/eng/HelpMenu.xhtml
 */
public class HelpMenuXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements HelpMenuXHTML, fr.imag.clips.papillon.presentation.xhtmlpivax.orig.HelpMenuXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlpivax/eng/HelpMenu.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Jibiki Wiki");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "href");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("http://www-clips.imag.fr/geta/hong-thai.nguyen/");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("PIVAX documentation");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "href");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("http://opera.dia.fi.upm.es/consorcio/index.php");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("U++C Home page");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "href");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("http://www.undl.org/");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("UNDL Fondation home");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("UNDL Fondation Home page");
        $elem4.appendChild($node5);
