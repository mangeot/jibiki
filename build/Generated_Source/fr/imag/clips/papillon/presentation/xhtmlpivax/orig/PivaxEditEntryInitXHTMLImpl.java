 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlpivax/orig/PivaxEditEntryInit.xhtml
 */
public class PivaxEditEntryInitXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements PivaxEditEntryInitXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final Class XMLC_GENERATED_CLASS = PivaxEditEntryInitXHTMLImpl.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class can be regenerated from.
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlpivax/orig/PivaxEditEntryInit.xhtml";
     ...
     * Default constructor.
     */
    public PivaxEditEntryInitXHTMLImpl() {
        buildDocument();
    }
     ...
     */
    public PivaxEditEntryInitXHTMLImpl(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     * Copy constructor.
     */
    public PivaxEditEntryInitXHTMLImpl(PivaxEditEntryInitXHTMLImpl src) {
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node4 = document.createTextNode("Edition of Pivax Entry");
        ...
        $node5 = document.createComment(" \n                // Open a new interface window to create the new entry \n                function create() {\n                    href = 'PivaxEditEntryInit.po?action=createAnyway&VOLUME=' + document.getElementById('VOLUME').value + '&Headword=' +  document.getElementById('Headword').value;\n                    window.open(href,'EditEntry');\n                }\n            //");
        $elem4.appendChild($node5);
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new PivaxEditEntryInitXHTMLImpl(this);
    }
