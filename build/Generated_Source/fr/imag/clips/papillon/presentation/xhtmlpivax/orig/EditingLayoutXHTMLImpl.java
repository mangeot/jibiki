 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlpivax/orig/EditingLayout.xhtml
 */
public class EditingLayoutXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements EditingLayoutXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.EditingLayoutXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlpivax/orig/EditingLayout.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $attr3 = document.createAttributeNS("", "content");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("Hong-Thai Nguyen, Francis Brunet-Manquat, Mathieu Mangeot & Gilles S\u00e9rasset");
        $attr3.appendChild($node4);
        ...
        $node4 = document.createTextNode("Pivax editing interface");
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("mailto:Hong-Thai.NguyenATimag.fr?subject=PivaxServer&body=replace\u00a0AT\u00a0by\u00a0@\u00a0in\u00a0the\u00a0email\u00a0address");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Hong-Thai Nguyen");
        ...
        $node4 = document.createTextNode(", GETALP-LIG. All rights reserved.");
        $elem3.appendChild($node4);
