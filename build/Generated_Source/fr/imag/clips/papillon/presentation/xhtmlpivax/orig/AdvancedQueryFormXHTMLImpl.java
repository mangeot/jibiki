 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlpivax/orig/AdvancedQueryForm.xhtml
 */
public class AdvancedQueryFormXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdvancedQueryFormXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.AdvancedQueryFormXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLInputElement $element_SavingQueryName;
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLSpanElement $element_SourceLanguageSelection;
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLDivElement $element_SystemSelection;

    private org.enhydra.xml.xhtml.dom.XHTMLOptionElement $element_SystemTmpl;
    ...
    /**
     * Class attribute constant for element class SourceLanguageSelection
     */
    public static final String CLASS_SourceLanguageSelection = "SourceLanguageSelection";
    ...
    /**
     * Element name constant for saveQuery
     */
    public static final String NAME_saveQuery = "saveQuery";

    /**
     * Element name constant for savingQueryName
     */
    public static final String NAME_savingQueryName = "savingQueryName";
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlpivax/orig/AdvancedQueryForm.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $attr6 = document.createAttributeNS("", "name");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("saveQuery");
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttributeNS("", "title");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("Remember search as");
        $attr6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "id");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("savingQueryName");
        $attr6.appendChild($node7);
        ...
        $element_SavingQueryName = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem6;$node6 = document.createTextNode("\n        ");
        $elem5.appendChild($node6);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $element_DictionaryTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("All\n                      dictionaries");
        $elem6.appendChild($node7);
        ...
        $node6 = document.createTextNode("where:");
        $elem5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "style");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("display:block; margin-left: 10px;");
        $attr5.appendChild($node6);
        ...
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("hideOrNotSourceLang(value, name);");
        $attr6.appendChild($node7);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("POS");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Assign to");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("pivax-assign-author");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("pivax-harmonising-status");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("pivax-process-status");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Access");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("pivax-access");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "label");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Project");
        $attr7.appendChild($node8);
        
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("pivax-project");
        $attr7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("cdm-contribution-id");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("Contribution Id");
        $elem7.appendChild($node8);
        ...
        $attr6 = document.createAttributeNS("", "id");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("ValueField");
        $attr6.appendChild($node7);
        ...
        $attr6 = document.createAttributeNS("", "name");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("FACETVALUE");
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttributeNS("", "size");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("18");
        $attr6.appendChild($node7);
        ...
        $element_ValueField = (org.enhydra.xml.xhtml.dom.XHTMLInputElement)$elem6;$node6 = document.createTextNode("\n                    ");
        $elem5.appendChild($node6);
        ...
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("SourceLanguageSelection");
        $attr6.appendChild($node7);
        ...
        $element_SourceLanguageSelection = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem6;$node7 = document.createTextNode("\n                      ");
        $elem6.appendChild($node7);
        ...
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("visibility: visible;");
        $attr7.appendChild($node8);
        ...
        $node9 = document.createTextNode("in all languages");
        ...
        $attr4 = document.createAttributeNS("", "id");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("SystemSelection");
        $attr4.appendChild($node5);
        ...
        $element_SystemSelection = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem4;$node5 = document.createTextNode("\n                  ");
        $elem4.appendChild($node5);
        
        $elem5 = document.createElementNS("http://www.w3.org/1999/xhtml", "b");
        $elem4.appendChild($elem5);
        
        $node6 = document.createTextNode("Systems :");
        $elem5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "id");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("System");
        $attr5.appendChild($node6);
        ...
        $element_System = (org.enhydra.xml.xhtml.dom.XHTMLSelectElement)$elem5;$elem6 = document.createElementNS("http://www.w3.org/1999/xhtml", "option");
        $elem5.appendChild($elem6);
        
        $attr6 = document.createAttributeNS("", "id");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("SystemTmpl");
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttributeNS("", "label");
        $elem6.setAttributeNode($attr6);
        $node7 = document.createTextNode("All systems");
        $attr6.appendChild($node7);
        ...
        $element_SystemTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("All\n                      systems");
        $elem6.appendChild($node7);
        ...
        $element_TargetTmpl = (org.enhydra.xml.xhtml.dom.XHTMLOptionElement)$elem6;$node7 = document.createTextNode("All\n                    languages");
        $elem6.appendChild($node7);
        ...
        $element_MyFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("My finished\n                    contributions");
        $elem5.appendChild($node6);
        ...
        $element_MyNotFinishedContributions = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("My not finished\n                    contributions");
        $elem5.appendChild($node6);
    ...
    /**
     * Get the element with id <CODE>savingQueryName</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLInputElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLInputElement getElementSavingQueryName() {
        return $element_SavingQueryName;
    }
    ...
    /**
     * Get the element with id <CODE>SourceLanguageSelection</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLSpanElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLSpanElement getElementSourceLanguageSelection() {
        return $element_SourceLanguageSelection;
    }
    ...
    /**
     * Get the element with id <CODE>SystemSelection</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLDivElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLDivElement getElementSystemSelection() {
        return $element_SystemSelection;
    }

    /**
     * Get the element with id <CODE>SystemTmpl</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLOptionElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLOptionElement getElementSystemTmpl() {
        return $element_SystemTmpl;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagSavingQueryName() {
        return $element_SavingQueryName;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagSourceLanguageSelection() {
        return $element_SourceLanguageSelection;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagSystemSelection() {
        return $element_SystemSelection;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagSystemTmpl() {
        return $element_SystemTmpl;
    }
    ...
    /**
     * Get the value of text child of element <CODE>SourceLanguageSelection</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextSourceLanguageSelection(String text) {
        doSetText($element_SourceLanguageSelection, text);
    }
    ...
    /**
     * Get the value of text child of element <CODE>SystemSelection</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextSystemSelection(String text) {
        doSetText($element_SystemSelection, text);
    }

    /**
     * Get the value of text child of element <CODE>SystemTmpl</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextSystemTmpl(String text) {
        doSetText($element_SystemTmpl, text);
    }
