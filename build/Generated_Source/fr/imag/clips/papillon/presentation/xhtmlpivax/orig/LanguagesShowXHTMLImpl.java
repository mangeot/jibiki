 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlpivax/orig/LanguagesShow.xhtml
 */
public class LanguagesShowXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LanguagesShowXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    private org.enhydra.xml.xhtml.dom.XHTMLDivElement $element_LanguageShow;

    private org.enhydra.xml.xhtml.dom.XHTMLAnchorElement $element_LanguageShowLink;
    ...
    /**
     * Element name constant for langShow
     */
    public static final String NAME_langShow = "langShow";

    /**
     * Field that is used to identify this as the XMLC generated class
     * in an inheritance chain. Contains a reference to the class object.
     */
    public static final Class XMLC_GENERATED_CLASS = LanguagesShowXHTMLImpl.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class can be regenerated from.
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlpivax/orig/LanguagesShow.xhtml";
     ...
     */
    public LanguagesShowXHTMLImpl(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     * Copy constructor.
     */
    public LanguagesShowXHTMLImpl(LanguagesShowXHTMLImpl src) {
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("LanguageShow");
        $attr3.appendChild($node4);
        
        $element_LanguageShow = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem3;$node4 = document.createTextNode("\n      ");
        $elem3.appendChild($node4);
        ...
        $node7 = document.createTextNode("justify");
        ...
        $node8 = document.createTextNode("fr");
        ...
        $elem8 = document.createElementNS("http://www.w3.org/1999/xhtml", "h2");
        ...
        $node10 = document.createTextNode("javascript:void(0)");
        $attr9.appendChild($node10);
        
        $attr9 = document.createAttributeNS("", "title");
        $elem9.setAttributeNode($attr9);
        $node10 = document.createTextNode("Languages");
        $attr9.appendChild($node10);
        ...
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("LanguageShowLink");
        $attr8.appendChild($node9);
        
        $attr8 = document.createAttributeNS("", "name");
        $elem8.setAttributeNode($attr8);
        $node9 = document.createTextNode("langShow");
        $attr8.appendChild($node9);
        ...
        $element_LanguageShowLink = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem8;$node9 = document.createTextNode("lang");
        $elem8.appendChild($node9);
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new LanguagesShowXHTMLImpl(this);
    }
    ...
    /**
     * Get the element with id <CODE>LanguageShow</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLDivElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLDivElement getElementLanguageShow() {
        return $element_LanguageShow;
    }

    /**
     * Get the element with id <CODE>LanguageShowLink</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLAnchorElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLAnchorElement getElementLanguageShowLink() {
        return $element_LanguageShowLink;
    }
     ...
     */
    public org.w3c.dom.Element getTagLanguageShow() {
        return $element_LanguageShow;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagLanguageShowLink() {
        return $element_LanguageShowLink;
    }

    /**
     * Get the value of text child of element <CODE>LanguageShow</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextLanguageShow(String text) {
        doSetText($element_LanguageShow, text);
    }

    /**
     * Get the value of text child of element <CODE>LanguageShowLink</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextLanguageShowLink(String text) {
        doSetText($element_LanguageShowLink, text);
    }
