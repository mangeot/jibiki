 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlgdef/est/QueryMenu.xhtml
 */
public class QueryMenuXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements QueryMenuXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.QueryMenuXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlgdef/est/QueryMenu.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("M\u00e4rks\u00f5na lihtotsing");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Lihtotsing:");
        ...
        $node10 = document.createTextNode("\u00f5na:");
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Otsing mitme erineva kriteeriumi alusel");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("T\u00e4ppisotsing");
        $elem4.appendChild($node5);
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("window.open('BrowseVolumePage.po?STATUS=validated&VOLUME=GDEF_est','Recherche alphab\u00e9tique d\\'un mot','width=200,height=700,resizable=no,scrollbars=no');return false;");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("S\u00f5nastike nimekiri");
        $attr4.appendChild($node5);
