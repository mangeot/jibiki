 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlgdef/eng/AdminContributionsTmpl.xhtml
 */
public class AdminContributionsTmplXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements AdminContributionsTmplXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.AdminContributionsTmplXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlgdef/eng/AdminContributionsTmpl.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node6 = document.createComment("tr>\t\n\t<td colspan=\"2\"><b>Upload existing contributions on selected volume</b></td>\n</tr>\n<tr>\t\n        <td><b><label for=\"URL\">Url:</label></b></td>\n\t\t\t\t<td><input id=\"URL\" name=\"URL\" type=\"text\" size=\"64\" value=\"\"/>\n\t\t\t\t<br/>\n        <input name=\"ADD\" type=\"submit\" value=\"Download\"/>\n\t\t\t\t</td>\n</tr");
        $elem5.appendChild($node6);
        
        $node4 = document.createTextNode("\n");
        $elem3.appendChild($node4);
        
        $node4 = document.createComment("form action=\"AdminContributions.po\" method=\"get\" onsubmit=\"return confirm('Are you sure you want to remove your contributions on selected volume?')\">\n<table width=\"600\" border=\"0\" cellspacing=\"0\" cellpadding=\"10\" summary=\"RemoveContrib\">\n<tr>\n<td><b><label for=\"EMPTY\">Remove the contributions on selected volume</label></b></td>\n        <td>\n        <input id=\"EMPTY\" name=\"EMPTY\" type=\"submit\" value=\"Remove\"/>\n        </td>\n</tr>\n</table>\n</form");
        $elem3.appendChild($node4);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $attr3 = document.createAttributeNS("", "label");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("translation id");
        $attr3.appendChild($node4);
        ...
        $attr3 = document.createAttributeNS("", "label");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("expl translations");
        $attr3.appendChild($node4);
        ...
        $attr3 = document.createAttributeNS("", "label");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("Loc translations");
        $attr3.appendChild($node4);
