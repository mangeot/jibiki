 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlgdef/eng/ConsultExpert.xhtml
 */
public class ConsultExpertXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements ConsultExpertXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.ConsultExpertXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlgdef/eng/ConsultExpert.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node10 = document.createTextNode("\u00a9 2002-2005 ");
        $elem9.appendChild($node10);
    ...
    private void buildSubDocument_0(org.w3c.dom.Document document,
        ...
        $attr5 = document.createAttributeNS("", "label");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("variant");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "value");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("cdm-headword-variant");
        $attr5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "label");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("domain");
        $attr5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "label");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("translation id");
        $attr5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "label");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("expl translations");
        $attr5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "label");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Loc translations");
        $attr5.appendChild($node6);
