 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlgdef/fra/QueryMenu.xhtml
 */
public class QueryMenuXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements QueryMenuXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.QueryMenuXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlgdef/fra/QueryMenu.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem10.setAttributeNode($attr10);
        $node11 = document.createTextNode("display:none;");
        $attr10.appendChild($node11);
        ...
        $attr7 = document.createAttributeNS("", "value");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("fra");
        $attr7.appendChild($node8);
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("window.open('BrowseVolumePage.po?VOLUME=GDEF_est&STATUS=validated','Recherche alphab\u00e9tique d\\'un mot','width=200,height=700,resizable=no,scrollbars=no');return false;");
        $attr4.appendChild($node5);
        
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Recherche Alphab\u00e9tique d'un mot");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Recherche alphab\u00e9tique");
        $elem4.appendChild($node5);
