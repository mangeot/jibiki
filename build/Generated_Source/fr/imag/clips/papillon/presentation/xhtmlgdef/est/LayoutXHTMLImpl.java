 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlgdef/est/Layout.xhtml
 */
public class LayoutXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LayoutXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.LayoutXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlgdef/est/Layout.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("et");
        $attr4.appendChild($node5);
        ...
        $node5 = document.createTextNode(" GDEF\n      ");
        $elem4.appendChild($node5);
        ...
        $node4 = document.createTextNode("Platvorm: \u00a9 2001-2006 ");
        $elem3.appendChild($node4);
        ...
        $node4 = document.createTextNode(", GETA-CLIPS. K\u00f5ik \u00f5igused kaitstud.");
        $elem3.appendChild($node4);
        
        $elem4 = document.createElementNS("http://www.w3.org/1999/xhtml", "br");
        $elem3.appendChild($elem4);
        
        $node4 = document.createTextNode("\n    Andmed: \u00a9 2004-2006 Eesti-Prantsuse Leksikograafia\u00fching ja Eesti Keele Instituut. K\u00f5ik \u00f5igused kaitstud.");
        $elem3.appendChild($node4);
