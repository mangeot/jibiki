 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlgdef/est/LangAndUser.xhtml
 */
public class LangAndUserXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LangAndUserXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.LangAndUserXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlgdef/est/LangAndUser.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Kasutaja toimingud");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Kasutaja:");
        ...
        $node8 = document.createTextNode("K");
        $elem7.appendChild($node8);
        
        $node7 = document.createTextNode("eel:");
        $elem6.appendChild($node7);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Logi sisse");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Sisene");
        $elem5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Kasutajaga seotud andmete vaatamine ja muutmine");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Seaded");
        $elem5.appendChild($node6);
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("return confirm('Oled kindel, et soovid v\u00e4ljuda?')");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Logi v\u00e4lja");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("V\u00e4lju");
        $elem5.appendChild($node6);
