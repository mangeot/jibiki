 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlgdef/orig/LinkerResultList.xhtml
 */
public class LinkerResultListXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LinkerResultListXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
    ...
    private org.enhydra.xml.xhtml.dom.XHTMLAnchorElement $element_CreateMissingEntryAnchor;
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlgdef/orig/LinkerResultList.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $element_NoResultsMessage = (org.enhydra.xml.xhtml.dom.XHTMLDivElement)$elem4;$node5 = document.createTextNode("Pas de r\u00e9sultat... ");
        ...
        $node6 = document.createTextNode("EditEntryInit.po?VOLUME=GDEF_fra&HEADWORD=");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "id");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("CreateMissingEntryAnchor");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "onclick");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("window.open(this.href,'_blank');return false;");
        $attr5.appendChild($node6);
        
        $element_CreateMissingEntryAnchor = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem5;$node6 = document.createTextNode("Cr\u00e9ez l'article");
        $elem5.appendChild($node6);
        
        $node5 = document.createTextNode(" dans la base fran\u00e7aise");
        $elem4.appendChild($node5);
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("display: block;");
        $attr4.appendChild($node5);
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("display: block;float: left; margin-left: 10px; margin-right: 20px;");
        $attr5.appendChild($node6);
        ...
        $element_Action = (org.enhydra.xml.xhtml.dom.XHTMLAnchorElement)$elem6;$node7 = document.createTextNode("relier !");
    ...
    /**
     * Get the element with id <CODE>CreateMissingEntryAnchor</CODE>.
     * @see org.enhydra.xml.xhtml.dom.XHTMLAnchorElement
     */
    public org.enhydra.xml.xhtml.dom.XHTMLAnchorElement getElementCreateMissingEntryAnchor() {
        return $element_CreateMissingEntryAnchor;
    }
     ...
     * @see org.w3c.dom.Element
     */
    public org.w3c.dom.Element getTagCreateMissingEntryAnchor() {
        return $element_CreateMissingEntryAnchor;
    }
    ...
    /**
     * Get the value of text child of element <CODE>CreateMissingEntryAnchor</CODE>.
     * @see org.w3c.dom.Text
     */
    public void setTextCreateMissingEntryAnchor(String text) {
        doSetText($element_CreateMissingEntryAnchor, text);
    }
