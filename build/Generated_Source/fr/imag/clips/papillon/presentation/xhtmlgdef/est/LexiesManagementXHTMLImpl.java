 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlgdef/est/LexiesManagement.xhtml
 */
public class LexiesManagementXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LexiesManagementXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.LexiesManagementXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlgdef/est/LexiesManagement.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Kirjete haldamine");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Artiklid:");
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Redigeeri olemasolevaid kirjeid");
        $attr4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Minu kaast\u00f6\u00f6");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Minu artiklid");
        $elem4.appendChild($node5);
