 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmlgdef/fra/Header.xhtml
 */
public class HeaderXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements HeaderXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.HeaderXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmlgdef/fra/Header.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $node6 = document.createTextNode("Accueil");
        ...
        $node6 = document.createTextNode("Informations");
        $elem5.appendChild($node6);
        ...
        $node8 = document.createTextNode("Information.po#Anchor-49575");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("Objectif");
        ...
        $attr7 = document.createAttributeNS("", "href");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Information.po#Anchor-47857");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("N\u00e9cessit\u00e9");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "href");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Information.po#Anchor-11481");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("Publics cibles");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "href");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Information.po#Anchor-35882");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("Aspects linguistiques");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "href");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Information.po#Anchor-14210");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("Aspects informatiques");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "href");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Information.po#Anchor-23240");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("Aspects institutionnels");
        $elem7.appendChild($node8);
        ...
        $attr7 = document.createAttributeNS("", "href");
        $elem7.setAttributeNode($attr7);
        $node8 = document.createTextNode("Information.po#Anchor-3800");
        $attr7.appendChild($node8);
        
        $node8 = document.createTextNode("D\u00e9bouch\u00e9s concrets");
        $elem7.appendChild($node8);
        ...
        $attr5 = document.createAttributeNS("", "href");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("News.po");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Nouvelles");
        $elem5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "href");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("phpBB2/index.php");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Forums");
        $elem5.appendChild($node6);
