 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmldri/eng/LangAndUser.xhtml
 */
public class LangAndUserXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LangAndUserXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.LangAndUserXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmldri/eng/LangAndUser.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("User Information Management");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("User:");
        ...
        $element_UserLogin = (org.enhydra.xml.xhtml.dom.XHTMLSpanElement)$elem4;$node5 = document.createTextNode("UserLogin");
        $elem4.appendChild($node5);
        ...
        $node7 = document.createTextNode("anguage:");
        $elem6.appendChild($node7);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Identify yourself to the Papillon website");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Sign In");
        $elem5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("View/Change your user name/password/address...");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("User Profile");
        $elem5.appendChild($node6);
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("return confirm('Are you sure you want to sign out?')");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Sign out from the Papillon website");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Sign out");
        $elem5.appendChild($node6);
