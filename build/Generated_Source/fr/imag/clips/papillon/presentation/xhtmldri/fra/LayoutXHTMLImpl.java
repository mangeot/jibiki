 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmldri/fra/Layout.xhtml
 */
public class LayoutXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LayoutXHTML, fr.imag.clips.papillon.presentation.xhtmldri.orig.LayoutXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmldri/fra/Layout.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $attr3 = document.createAttributeNS("", "content");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("INRIA DRI Dictionary");
        $attr3.appendChild($node4);
        ...
        $attr3 = document.createAttributeNS("", "content");
        $elem3.setAttributeNode($attr3);
        $node4 = document.createTextNode("Dictionary by and for trainees of the INRIA DRI");
        $attr3.appendChild($node4);
        ...
        $node4 = document.createTextNode("Le dictionnaire des stagiaires de la DRI INRIA");
        ...
        $node6 = document.createTextNode("INRIA");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "id");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("logo");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "src");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("media/dri/INRIA.jpg");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "width");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("170px");
        $attr5.appendChild($node6);
        
        $element_Logo = (org.enhydra.xml.xhtml.dom.XHTMLImageElement)$elem5;$node5 = document.createTextNode(" Dictionnaire des stagiaires de la DRI ");
        $elem4.appendChild($node5);
        ...
        $attr5 = document.createAttributeNS("", "href");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Search.po");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Chercher");
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("Plan du site");
        $elem5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "href");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("http://www.inria.fr");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("INRIA Home Page");
        $attr5.appendChild($node6);
        ...
        $node7 = document.createTextNode("cr\u00e9\u00e9 avec Jibiki");
        ...
        $node5 = document.createTextNode("Le dictionnaire DRI est optimis\u00e9e pour le navigateur gratuit\u00a0: ");
        $elem4.appendChild($node5);
        ...
        $node4 = document.createTextNode("\n        Plateform: \u00a9 2001-2007, GETA-CLIPS, GETALP-LIG. All rights reserved.");
        $elem3.appendChild($node4);
