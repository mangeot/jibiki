 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmldri/orig/LexiesManagement.xhtml
 */
public class LexiesManagementXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LexiesManagementXHTML, fr.imag.clips.papillon.presentation.xhtml.orig.LexiesManagementXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.LexiesManagementXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmldri/orig/LexiesManagement.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Gestion d'un article dans un dictionnaire");
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Articles");
        ...
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Cr\u00e9er un nouvel article");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Cr\u00e9er");
        $elem4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("\u00c9diter un article");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("\u00c9diter");
        $elem4.appendChild($node5);
        ...
        $attr4 = document.createAttributeNS("", "title");
        $elem4.setAttributeNode($attr4);
        $node5 = document.createTextNode("Exporter vers pdf");
        $attr4.appendChild($node5);
        
        $node5 = document.createTextNode("Exporter");
        $elem4.appendChild($node5);
        ...
        $node4 = document.createComment("<a title=\"Gestion de mes contributions\" href=\"AdminContributions.po\">Mes contributions</a>\n      <br/>");
        $elem3.appendChild($node4);
