 ...
 * /Users/yingzhang/Projet/LINKS_1_0/src/fr/imag/clips/papillon/resources/xhtmldri/deu/LangAndUser.xhtml
 */
public class LangAndUserXHTMLImpl extends org.enhydra.xml.xmlc.html.HTMLObjectImpl implements LangAndUserXHTML, fr.imag.clips.papillon.presentation.xhtmllexalp.orig.LangAndUserXHTML, org.enhydra.xml.xmlc.XMLObject, org.enhydra.xml.xmlc.html.HTMLObject {
     ...
     */
    public static final String XMLC_SOURCE_FILE = "fr/imag/clips/papillon/presentation/xhtmldri/deu/LangAndUser.xhtml";
    ...
    private org.enhydra.xml.xhtml.dom.xerces.XHTMLDocumentImpl buildSubDocument() {
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Benutzer");
        $attr5.appendChild($node6);
        ...
        $node7 = document.createTextNode("k");
        ...
        $node7 = document.createTextNode("prache:");
        $elem6.appendChild($node7);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Einloggen");
        $attr5.appendChild($node6);
        ...
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Benutzerprofil...");
        $attr5.appendChild($node6);
        ...
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("return confirm('Ausloggen?')");
        $attr5.appendChild($node6);
        
        $attr5 = document.createAttributeNS("", "title");
        $elem5.setAttributeNode($attr5);
        $node6 = document.createTextNode("Ausloggen");
        $attr5.appendChild($node6);
