...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/volume">
       ...
       <fo:block break-before="page" space-before="10mm" space-after="10mm" font-size="18pt"
        ...
        <xsl:apply-templates select="d:contribution/d:data/entry[@lang='ita' and domain[1]='&DOMAIN_NUMBER']"
        ...
        <xsl:apply-templates select="d:contribution/d:data/entry[@lang='fra' and domain[1]='&DOMAIN_NUMBER']"
            xmlns:d="http://www-clips.imag.fr/geta/services/dml"/>
        ...
        <xsl:apply-templates select="d:contribution/d:data/entry[@lang='deu' and domain[1]='&DOMAIN_NUMBER']"
            xmlns:d="http://www-clips.imag.fr/geta/services/dml"/>
       ...
       <fo:block space-before="10mm" space-after="10mm" font-size="18pt"
        ...
        <xsl:apply-templates select="d:contribution/d:data/entry[@lang='slv' and domain[1]='&DOMAIN_NUMBER']"
            xmlns:d="http://www-clips.imag.fr/geta/services/dml"/>
