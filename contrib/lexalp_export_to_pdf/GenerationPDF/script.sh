...
# ./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.3 2
# ./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.4 2 
# ./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.5 2 
...
# ./generatePDF.sh fusionTermes.xml fusion.xml tout 2 2.0 2 
# ./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.1 2 
# ./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.2 2
# ./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.3 2 
# ./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.4 2 
...
#./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.0 2
# enlever les doublons de temp_fo
#./generatePDF.sh fusionTermes.xml fusion.xml generate 2 2.0 2
#./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.2 2 
# enlever les doublons de temp_fo
#./generatePDF.sh fusionTermes.xml fusion.xml generate 2 2.2 2
#./generatePDF.sh fusionTermes.xml fusion.xml specifique 2 2.9 2 
# enlever les doublons de temp_fo
#./generatePDF.sh fusionTermes.xml fusion.xml generate 2 2.9 2
